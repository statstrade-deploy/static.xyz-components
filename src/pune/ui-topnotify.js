...
// pune.ui-topnotify/getOutdated [26] 
...
// pune.ui-topnotify/useOutdated [38] 
...
// pune.ui-topnotify/TopNotifyInner [59] 
...
// pune.ui-topnotify/TopNotify [159] 
function TopNotify({data,design,mini,onClose,variant}){
  ...
  return mini ? React.createElement(ui_util.Fold,{visible},notifyElem) : React.createElement(
    ui_notify.Notify,
    {visible,"position":"bottom_right","transition":"from_bottom","margin":10},
    notifyElem
  );
}

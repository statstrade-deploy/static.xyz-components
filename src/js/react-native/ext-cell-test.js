...
function SimpleCellDemo(){
  ...
  return (
    <n.Enclosed label="js.react-native.ext-cell-test/SimpleCell">
      <n.Row>
        <ReactNative.Button
          title="Print"
          onPress={function (){
...
function SimpleCellViewsDemo(){
  ...
  return (
    <n.Enclosed label="js.react-native.ext-cell-test/SimpleCellViews">
      <n.TreePane
        tree={cell}
        levels={[
          {
...
function ListenCurrentDemo(){
  ...
  return (
    <n.Enclosed label="js.react-native.ext-cell-test/listen-current">

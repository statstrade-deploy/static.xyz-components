...
function DigitRollerStaticDemo(){
  ...
  return (
    <n.Enclosed label="js.react-native.physical-play/DigitRollerStatic">
      <n.Row>
...
function DigitRollerSingleDemo(){
  ...
  return (
    <n.Enclosed label="js.react-native.physical-play/DigitRollerSingle">
      <n.Row>
        <physical_base.Box
...
function DigitRollerDoubleDemo(){
  ...
  return (
    <n.Enclosed label="js.react-native.physical-play/DigitRollerDouble">
      <n.Row>
        <physical_base.Box
...
function DigitClockDemo(){
  ...
  return (
    <n.Enclosed label="js.react-native.physical-play/DigitClock">
      <n.Row>
        <ReactNative.View>
          <physical_base.Box

      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.06684078263837567},
              {"id":"id-1","name":"name-1","amount":0.175705637603504},
              {"id":"id-2","name":"name-2","amount":0.5587246842388907},
              {"id":"id-3","name":"name-3","amount":0.9145003487421802},
              {"id":"id-4","name":"name-4","amount":0.6831293135855118},
              {"id":"id-5","name":"name-5","amount":0.7474792144033695},
              {"id":"id-6","name":"name-6","amount":0.3489920347004758},
              {"id":"id-7","name":"name-7","amount":0.6752521685431383},
              {"id":"id-8","name":"name-8","amount":0.0924157189631255},
              {"id":"id-9","name":"name-9","amount":0.8526906133216648},
              {"id":"id-10","name":"name-10","amount":0.10235808052360773},
              {"id":"id-11","name":"name-11","amount":0.08807371060894797},
              {"id":"id-12","name":"name-12","amount":0.34225968396548767},
              {"id":"id-13","name":"name-13","amount":0.11261351375450124},
              {"id":"id-14","name":"name-14","amount":0.5747206999218679},
              {"id":"id-15","name":"name-15","amount":0.0686984808492147},
              {"id":"id-16","name":"name-16","amount":0.6145288746286124},
              {"id":"id-17","name":"name-17","amount":0.6476514772381968},
              {"id":"id-18","name":"name-18","amount":0.38113330079717045},
              {"id":"id-19","name":"name-19","amount":0.344514163695839},
              {"id":"id-20","name":"name-20","amount":0.17102785619912764},
              {"id":"id-21","name":"name-21","amount":0.8658866240945169},
              {"id":"id-22","name":"name-22","amount":0.6650555859041496},
              {"id":"id-23","name":"name-23","amount":0.6953287321674988},
              {"id":"id-24","name":"name-24","amount":0.1825966040915289},
              {"id":"id-25","name":"name-25","amount":0.6980629942142248},
              {"id":"id-26","name":"name-26","amount":0.5168118407498363},
              {"id":"id-27","name":"name-27","amount":0.8321150590589393},
              {"id":"id-28","name":"name-28","amount":0.7710547174791761},
              {"id":"id-29","name":"name-29","amount":0.06663324858004316},
              {"id":"id-30","name":"name-30","amount":0.17033991559551842},
              {"id":"id-31","name":"name-31","amount":0.42060056696487913},
              {"id":"id-32","name":"name-32","amount":0.06309442082946848},
              {"id":"id-33","name":"name-33","amount":0.1977855964706905},
              {"id":"id-34","name":"name-34","amount":0.7426657941745166},
              {"id":"id-35","name":"name-35","amount":0.4684824592134442},
              {"id":"id-36","name":"name-36","amount":0.3062012390952794},
              {"id":"id-37","name":"name-37","amount":0.2379076025014184},
              {"id":"id-38","name":"name-38","amount":0.29714005984096004},
              {"id":"id-39","name":"name-39","amount":0.5382128234324142},
              {"id":"id-40","name":"name-40","amount":0.1289088082428692},
              {"id":"id-41","name":"name-41","amount":0.519731753203073},
              {"id":"id-42","name":"name-42","amount":0.3093243106692569},
              {"id":"id-43","name":"name-43","amount":0.0217128994204957},
              {"id":"id-44","name":"name-44","amount":0.8411696706222435},
              {"id":"id-45","name":"name-45","amount":0.7384478315928497},
              {"id":"id-46","name":"name-46","amount":0.1935170275842406},
              {"id":"id-47","name":"name-47","amount":0.019038313053866718},
              {"id":"id-48","name":"name-48","amount":0.2653517386304094},
              {"id":"id-49","name":"name-49","amount":0.24435499841351072},
              {"id":"id-50","name":"name-50","amount":0.40825951921442716},
              {"id":"id-51","name":"name-51","amount":0.199932954281708},
              {"id":"id-52","name":"name-52","amount":0.9643453684898946},
              {"id":"id-53","name":"name-53","amount":0.6361664509599165},
              {"id":"id-54","name":"name-54","amount":0.8007655144938377},
              {"id":"id-55","name":"name-55","amount":0.39537159512153164},
              {"id":"id-56","name":"name-56","amount":0.890493884170641},
              {"id":"id-57","name":"name-57","amount":0.8478681676028967},
              {"id":"id-58","name":"name-58","amount":0.273067503882661},
              {"id":"id-59","name":"name-59","amount":0.5656067253563034},
              {"id":"id-60","name":"name-60","amount":0.4175355502037754},
              {"id":"id-61","name":"name-61","amount":0.9620726195221584},
              {"id":"id-62","name":"name-62","amount":0.5567763589038157},
              {"id":"id-63","name":"name-63","amount":0.22189799043679825},
              {"id":"id-64","name":"name-64","amount":0.43747299930625105},
              {"id":"id-65","name":"name-65","amount":0.05409668243506538},
              {"id":"id-66","name":"name-66","amount":0.8687012478682276},
              {"id":"id-67","name":"name-67","amount":0.34101784607823726},
              {"id":"id-68","name":"name-68","amount":0.7052613586181656},
              {"id":"id-69","name":"name-69","amount":0.47353315637853666},
              {"id":"id-70","name":"name-70","amount":0.4861787047207844},
              {"id":"id-71","name":"name-71","amount":0.3047899629488914},
              {"id":"id-72","name":"name-72","amount":0.8964337639375356},
              {"id":"id-73","name":"name-73","amount":0.10387341166390052},
              {"id":"id-74","name":"name-74","amount":0.8288113630618731},
              {"id":"id-75","name":"name-75","amount":0.4213319483248811},
              {"id":"id-76","name":"name-76","amount":0.9062593710684665},
              {"id":"id-77","name":"name-77","amount":0.305777957531313},
              {"id":"id-78","name":"name-78","amount":0.46241838328961804},
              {"id":"id-79","name":"name-79","amount":0.14033725513026163},
              {"id":"id-80","name":"name-80","amount":0.7637549931267763},
              {"id":"id-81","name":"name-81","amount":0.4458813870197391},
              {"id":"id-82","name":"name-82","amount":0.55135097746543},
              {"id":"id-83","name":"name-83","amount":0.16164586653967572},
              {"id":"id-84","name":"name-84","amount":0.15984882600572803},
              {"id":"id-85","name":"name-85","amount":0.14055626489072082},
              {"id":"id-86","name":"name-86","amount":0.6769284189883024},
              {"id":"id-87","name":"name-87","amount":0.2545168387868436},
              {"id":"id-88","name":"name-88","amount":0.9962208379962282},
              {"id":"id-89","name":"name-89","amount":0.602850388255839},
              {"id":"id-90","name":"name-90","amount":0.6126009925530063},
              {"id":"id-91","name":"name-91","amount":0.7544301272573535},
              {"id":"id-92","name":"name-92","amount":0.5498208136990678},
              {"id":"id-93","name":"name-93","amount":0.7708503028127403},
              {"id":"id-94","name":"name-94","amount":0.6005481928963293},
              {"id":"id-95","name":"name-95","amount":0.3849092980696527},
              {"id":"id-96","name":"name-96","amount":0.8177921740940507},
              {"id":"id-97","name":"name-97","amount":0.21701378780999292},
              {"id":"id-98","name":"name-98","amount":0.909772120125952},
              {"id":"id-99","name":"name-99","amount":0.2637705305475616}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.9563658611046342},
              {"id":"id-1","name":"name-1","amount":0.09172679612099566},
              {"id":"id-2","name":"name-2","amount":0.4130322045026543},
              {"id":"id-3","name":"name-3","amount":0.969979176779836},
              {"id":"id-4","name":"name-4","amount":0.3633985292918669},
              {"id":"id-5","name":"name-5","amount":0.0706385518569761},
              {"id":"id-6","name":"name-6","amount":0.4845209811932195},
              {"id":"id-7","name":"name-7","amount":0.6869213466601982},
              {"id":"id-8","name":"name-8","amount":0.46185732426310544},
              {"id":"id-9","name":"name-9","amount":0.31031438246036025},
              {"id":"id-10","name":"name-10","amount":0.6471490888274656},
              {"id":"id-11","name":"name-11","amount":0.9705615653529764},
              {"id":"id-12","name":"name-12","amount":0.9416085588092385},
              {"id":"id-13","name":"name-13","amount":0.8565268038332855},
              {"id":"id-14","name":"name-14","amount":0.8072254240382558},
              {"id":"id-15","name":"name-15","amount":0.7201834385409301},
              {"id":"id-16","name":"name-16","amount":0.4048680863694226},
              {"id":"id-17","name":"name-17","amount":0.03162266205391229},
              {"id":"id-18","name":"name-18","amount":0.7911768560733041},
              {"id":"id-19","name":"name-19","amount":0.15851842137439576},
              {"id":"id-20","name":"name-20","amount":0.3858221275688909},
              {"id":"id-21","name":"name-21","amount":0.9117886749367901},
              {"id":"id-22","name":"name-22","amount":0.9459420729183853},
              {"id":"id-23","name":"name-23","amount":0.06872805397321669},
              {"id":"id-24","name":"name-24","amount":0.5955222936655189},
              {"id":"id-25","name":"name-25","amount":0.15975634971123687},
              {"id":"id-26","name":"name-26","amount":0.9847962765568702},
              {"id":"id-27","name":"name-27","amount":0.10485800821078983},
              {"id":"id-28","name":"name-28","amount":0.969721954014115},
              {"id":"id-29","name":"name-29","amount":0.696130697716584},
              {"id":"id-30","name":"name-30","amount":0.7661374794537396},
              {"id":"id-31","name":"name-31","amount":0.4445936934313568},
              {"id":"id-32","name":"name-32","amount":0.9498601784177536},
              {"id":"id-33","name":"name-33","amount":0.7091295089864761},
              {"id":"id-34","name":"name-34","amount":0.9359286506808588},
              {"id":"id-35","name":"name-35","amount":0.08537300128394054},
              {"id":"id-36","name":"name-36","amount":0.3111886793575387},
              {"id":"id-37","name":"name-37","amount":0.8003708112305253},
              {"id":"id-38","name":"name-38","amount":0.13890475143297354},
              {"id":"id-39","name":"name-39","amount":0.8983889607225793},
              {"id":"id-40","name":"name-40","amount":0.7670760961457969},
              {"id":"id-41","name":"name-41","amount":0.6434481714271818},
              {"id":"id-42","name":"name-42","amount":0.8093170740092628},
              {"id":"id-43","name":"name-43","amount":0.14974091141140233},
              {"id":"id-44","name":"name-44","amount":0.5248133331897361},
              {"id":"id-45","name":"name-45","amount":0.3923850052843376},
              {"id":"id-46","name":"name-46","amount":0.3889016100368323},
              {"id":"id-47","name":"name-47","amount":0.5739703718249826},
              {"id":"id-48","name":"name-48","amount":0.9457821764808949},
              {"id":"id-49","name":"name-49","amount":0.21866018921552732},
              {"id":"id-50","name":"name-50","amount":0.1879227075345169},
              {"id":"id-51","name":"name-51","amount":0.2424431880462301},
              {"id":"id-52","name":"name-52","amount":0.4716389883900344},
              {"id":"id-53","name":"name-53","amount":0.7783495262369088},
              {"id":"id-54","name":"name-54","amount":0.004556288921912066},
              {"id":"id-55","name":"name-55","amount":0.407517077269116},
              {"id":"id-56","name":"name-56","amount":0.01820426681860443},
              {"id":"id-57","name":"name-57","amount":0.11502863202888403},
              {"id":"id-58","name":"name-58","amount":0.04854213346115255},
              {"id":"id-59","name":"name-59","amount":0.22315967552723792},
              {"id":"id-60","name":"name-60","amount":0.11003747425396149},
              {"id":"id-61","name":"name-61","amount":0.4894345323783478},
              {"id":"id-62","name":"name-62","amount":0.6769479310466331},
              {"id":"id-63","name":"name-63","amount":0.7436589122670155},
              {"id":"id-64","name":"name-64","amount":0.13121625560991845},
              {"id":"id-65","name":"name-65","amount":0.8934849979685753},
              {"id":"id-66","name":"name-66","amount":0.9430522381837905},
              {"id":"id-67","name":"name-67","amount":0.8842942349092155},
              {"id":"id-68","name":"name-68","amount":0.20162773573280812},
              {"id":"id-69","name":"name-69","amount":0.554105850571865},
              {"id":"id-70","name":"name-70","amount":0.9837675617014507},
              {"id":"id-71","name":"name-71","amount":0.09131367097715115},
              {"id":"id-72","name":"name-72","amount":0.353118895662325},
              {"id":"id-73","name":"name-73","amount":0.5614184525262641},
              {"id":"id-74","name":"name-74","amount":0.8266887102347196},
              {"id":"id-75","name":"name-75","amount":0.31328797351659243},
              {"id":"id-76","name":"name-76","amount":0.8761418939642603},
              {"id":"id-77","name":"name-77","amount":0.8661907594189366},
              {"id":"id-78","name":"name-78","amount":0.2847657348317759},
              {"id":"id-79","name":"name-79","amount":0.49189042889103285},
              {"id":"id-80","name":"name-80","amount":0.9350696389778198},
              {"id":"id-81","name":"name-81","amount":0.2830572387769199},
              {"id":"id-82","name":"name-82","amount":0.22476460232947126},
              {"id":"id-83","name":"name-83","amount":0.1973764535835204},
              {"id":"id-84","name":"name-84","amount":0.8091453352192558},
              {"id":"id-85","name":"name-85","amount":0.8088642196708223},
              {"id":"id-86","name":"name-86","amount":0.6450933706998865},
              {"id":"id-87","name":"name-87","amount":0.22251462346541917},
              {"id":"id-88","name":"name-88","amount":0.406069581147667},
              {"id":"id-89","name":"name-89","amount":0.5195988676485904},
              {"id":"id-90","name":"name-90","amount":0.6792349037246058},
              {"id":"id-91","name":"name-91","amount":0.9184467931326438},
              {"id":"id-92","name":"name-92","amount":0.016516995202730422},
              {"id":"id-93","name":"name-93","amount":0.5447118571255065},
              {"id":"id-94","name":"name-94","amount":0.8529418894248831},
              {"id":"id-95","name":"name-95","amount":0.806931396610906},
              {"id":"id-96","name":"name-96","amount":0.6304136915548062},
              {"id":"id-97","name":"name-97","amount":0.13424482167599028},
              {"id":"id-98","name":"name-98","amount":0.6665137433794731},
              {"id":"id-99","name":"name-99","amount":0.535651335929332}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

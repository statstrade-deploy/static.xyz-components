      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.25648460545950347},
              {"id":"id-1","name":"name-1","amount":0.14840982851572415},
              {"id":"id-2","name":"name-2","amount":0.8099772266882358},
              {"id":"id-3","name":"name-3","amount":0.9038326283338298},
              {"id":"id-4","name":"name-4","amount":0.34462712964209896},
              {"id":"id-5","name":"name-5","amount":0.7000210635688247},
              {"id":"id-6","name":"name-6","amount":0.42707166454324563},
              {"id":"id-7","name":"name-7","amount":0.4923838806110543},
              {"id":"id-8","name":"name-8","amount":0.44263450914525815},
              {"id":"id-9","name":"name-9","amount":0.298006111830334},
              {"id":"id-10","name":"name-10","amount":0.9017597641102687},
              {"id":"id-11","name":"name-11","amount":0.8248471106935735},
              {"id":"id-12","name":"name-12","amount":0.406792212337754},
              {"id":"id-13","name":"name-13","amount":0.14237777451044187},
              {"id":"id-14","name":"name-14","amount":0.02342688870512577},
              {"id":"id-15","name":"name-15","amount":0.514492727043168},
              {"id":"id-16","name":"name-16","amount":0.5835489861738976},
              {"id":"id-17","name":"name-17","amount":0.6067997271235415},
              {"id":"id-18","name":"name-18","amount":0.6717602049346734},
              {"id":"id-19","name":"name-19","amount":0.4364130813947049},
              {"id":"id-20","name":"name-20","amount":0.8543329138087172},
              {"id":"id-21","name":"name-21","amount":0.6111695068911405},
              {"id":"id-22","name":"name-22","amount":0.18747219147391558},
              {"id":"id-23","name":"name-23","amount":0.6428744303574522},
              {"id":"id-24","name":"name-24","amount":0.48554058757672547},
              {"id":"id-25","name":"name-25","amount":0.7800335806541955},
              {"id":"id-26","name":"name-26","amount":0.9863834198376934},
              {"id":"id-27","name":"name-27","amount":0.8319111480348523},
              {"id":"id-28","name":"name-28","amount":0.3702774188519259},
              {"id":"id-29","name":"name-29","amount":0.6181888092751648},
              {"id":"id-30","name":"name-30","amount":0.9746350274789141},
              {"id":"id-31","name":"name-31","amount":0.8256145833820032},
              {"id":"id-32","name":"name-32","amount":0.10487301265582061},
              {"id":"id-33","name":"name-33","amount":0.3615815729901134},
              {"id":"id-34","name":"name-34","amount":0.6323703828723328},
              {"id":"id-35","name":"name-35","amount":0.5194496530354149},
              {"id":"id-36","name":"name-36","amount":0.35589051782295666},
              {"id":"id-37","name":"name-37","amount":0.9946240116385623},
              {"id":"id-38","name":"name-38","amount":0.5990466454510733},
              {"id":"id-39","name":"name-39","amount":0.6750673797501822},
              {"id":"id-40","name":"name-40","amount":0.14229413006404779},
              {"id":"id-41","name":"name-41","amount":0.16430462502574272},
              {"id":"id-42","name":"name-42","amount":0.21560685288763892},
              {"id":"id-43","name":"name-43","amount":0.7464620982618422},
              {"id":"id-44","name":"name-44","amount":0.982634639297705},
              {"id":"id-45","name":"name-45","amount":0.3669780953758921},
              {"id":"id-46","name":"name-46","amount":0.7570636272926011},
              {"id":"id-47","name":"name-47","amount":0.6529570738645328},
              {"id":"id-48","name":"name-48","amount":0.3385576734441532},
              {"id":"id-49","name":"name-49","amount":0.8354774852824173},
              {"id":"id-50","name":"name-50","amount":0.023615760878619052},
              {"id":"id-51","name":"name-51","amount":0.042383052380840835},
              {"id":"id-52","name":"name-52","amount":0.42363509524359344},
              {"id":"id-53","name":"name-53","amount":0.012198874390896952},
              {"id":"id-54","name":"name-54","amount":0.5492392824409118},
              {"id":"id-55","name":"name-55","amount":0.1239487556131722},
              {"id":"id-56","name":"name-56","amount":0.2404649939329585},
              {"id":"id-57","name":"name-57","amount":0.35806761744384785},
              {"id":"id-58","name":"name-58","amount":0.93376520804477},
              {"id":"id-59","name":"name-59","amount":0.5926840122018293},
              {"id":"id-60","name":"name-60","amount":0.659181131485222},
              {"id":"id-61","name":"name-61","amount":0.5178018178887501},
              {"id":"id-62","name":"name-62","amount":0.7077758653943916},
              {"id":"id-63","name":"name-63","amount":0.5159695702219127},
              {"id":"id-64","name":"name-64","amount":0.4569581214515046},
              {"id":"id-65","name":"name-65","amount":0.5386474410024613},
              {"id":"id-66","name":"name-66","amount":0.6992228803745588},
              {"id":"id-67","name":"name-67","amount":0.30755035024854094},
              {"id":"id-68","name":"name-68","amount":0.5007937839282197},
              {"id":"id-69","name":"name-69","amount":0.9227669237185813},
              {"id":"id-70","name":"name-70","amount":0.08648912443454104},
              {"id":"id-71","name":"name-71","amount":0.07556168126343543},
              {"id":"id-72","name":"name-72","amount":0.6747953010203235},
              {"id":"id-73","name":"name-73","amount":0.7827209035942614},
              {"id":"id-74","name":"name-74","amount":0.19468841945538307},
              {"id":"id-75","name":"name-75","amount":0.6984806633459033},
              {"id":"id-76","name":"name-76","amount":0.728391842753569},
              {"id":"id-77","name":"name-77","amount":0.26499060780544603},
              {"id":"id-78","name":"name-78","amount":0.6203161419613799},
              {"id":"id-79","name":"name-79","amount":0.9565482636689636},
              {"id":"id-80","name":"name-80","amount":0.9533402783724302},
              {"id":"id-81","name":"name-81","amount":0.7082461719878872},
              {"id":"id-82","name":"name-82","amount":0.4539347266897059},
              {"id":"id-83","name":"name-83","amount":0.9260896023140304},
              {"id":"id-84","name":"name-84","amount":0.4850874391362203},
              {"id":"id-85","name":"name-85","amount":0.7110741898837961},
              {"id":"id-86","name":"name-86","amount":0.21139811603770764},
              {"id":"id-87","name":"name-87","amount":0.6302936832027255},
              {"id":"id-88","name":"name-88","amount":0.06799662776308346},
              {"id":"id-89","name":"name-89","amount":0.3981351595352225},
              {"id":"id-90","name":"name-90","amount":0.5811897778697938},
              {"id":"id-91","name":"name-91","amount":0.6323958030282598},
              {"id":"id-92","name":"name-92","amount":0.3241418786974364},
              {"id":"id-93","name":"name-93","amount":0.6942299187198719},
              {"id":"id-94","name":"name-94","amount":0.2487688721957526},
              {"id":"id-95","name":"name-95","amount":0.8558392312010425},
              {"id":"id-96","name":"name-96","amount":0.92181843350181},
              {"id":"id-97","name":"name-97","amount":0.3425113566742638},
              {"id":"id-98","name":"name-98","amount":0.8683898731376897},
              {"id":"id-99","name":"name-99","amount":0.42087560405630076}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.13355893125221374},
              {"id":"id-1","name":"name-1","amount":0.22036515368499332},
              {"id":"id-2","name":"name-2","amount":0.2917691213257686},
              {"id":"id-3","name":"name-3","amount":0.08101601685671844},
              {"id":"id-4","name":"name-4","amount":0.6101115702183495},
              {"id":"id-5","name":"name-5","amount":0.6799111844767106},
              {"id":"id-6","name":"name-6","amount":0.2963484811270013},
              {"id":"id-7","name":"name-7","amount":0.8371811916894155},
              {"id":"id-8","name":"name-8","amount":0.013753339936144138},
              {"id":"id-9","name":"name-9","amount":0.47177212726235684},
              {"id":"id-10","name":"name-10","amount":0.8628133897414636},
              {"id":"id-11","name":"name-11","amount":0.19548409978992543},
              {"id":"id-12","name":"name-12","amount":0.022866989878650767},
              {"id":"id-13","name":"name-13","amount":0.8530443698003203},
              {"id":"id-14","name":"name-14","amount":0.5450848727076016},
              {"id":"id-15","name":"name-15","amount":0.11209827106572479},
              {"id":"id-16","name":"name-16","amount":0.6450649994376244},
              {"id":"id-17","name":"name-17","amount":0.7418710647925877},
              {"id":"id-18","name":"name-18","amount":0.27225402183162417},
              {"id":"id-19","name":"name-19","amount":0.35403867040034487},
              {"id":"id-20","name":"name-20","amount":0.9346304612520728},
              {"id":"id-21","name":"name-21","amount":0.6345520311447965},
              {"id":"id-22","name":"name-22","amount":0.8839039391109741},
              {"id":"id-23","name":"name-23","amount":0.06942256867833996},
              {"id":"id-24","name":"name-24","amount":0.17534788162473902},
              {"id":"id-25","name":"name-25","amount":0.7875508941301145},
              {"id":"id-26","name":"name-26","amount":0.6168600427990142},
              {"id":"id-27","name":"name-27","amount":0.9144522234003128},
              {"id":"id-28","name":"name-28","amount":0.7266310076772311},
              {"id":"id-29","name":"name-29","amount":0.08520666180907976},
              {"id":"id-30","name":"name-30","amount":0.9937165402213015},
              {"id":"id-31","name":"name-31","amount":0.914273569698491},
              {"id":"id-32","name":"name-32","amount":0.649798846705666},
              {"id":"id-33","name":"name-33","amount":0.0032140074034701094},
              {"id":"id-34","name":"name-34","amount":0.9355577217250858},
              {"id":"id-35","name":"name-35","amount":0.8022487597640366},
              {"id":"id-36","name":"name-36","amount":0.3065475283647824},
              {"id":"id-37","name":"name-37","amount":0.4734451386787605},
              {"id":"id-38","name":"name-38","amount":0.9496119039999575},
              {"id":"id-39","name":"name-39","amount":0.05581226430131503},
              {"id":"id-40","name":"name-40","amount":0.35311017898695074},
              {"id":"id-41","name":"name-41","amount":0.2574433651291773},
              {"id":"id-42","name":"name-42","amount":0.9271477298902768},
              {"id":"id-43","name":"name-43","amount":0.22696371639300716},
              {"id":"id-44","name":"name-44","amount":0.9412924799632818},
              {"id":"id-45","name":"name-45","amount":0.6439265570559513},
              {"id":"id-46","name":"name-46","amount":0.42774102115421375},
              {"id":"id-47","name":"name-47","amount":0.45158344131440875},
              {"id":"id-48","name":"name-48","amount":0.48151727891556195},
              {"id":"id-49","name":"name-49","amount":0.8998964949948471},
              {"id":"id-50","name":"name-50","amount":0.32311263296728543},
              {"id":"id-51","name":"name-51","amount":0.21413880948595643},
              {"id":"id-52","name":"name-52","amount":0.02320624677133054},
              {"id":"id-53","name":"name-53","amount":0.925457827098514},
              {"id":"id-54","name":"name-54","amount":0.32705607041986695},
              {"id":"id-55","name":"name-55","amount":0.5429834239753123},
              {"id":"id-56","name":"name-56","amount":0.1642725249070054},
              {"id":"id-57","name":"name-57","amount":0.989208060518454},
              {"id":"id-58","name":"name-58","amount":0.2475459699394963},
              {"id":"id-59","name":"name-59","amount":0.8163328940569412},
              {"id":"id-60","name":"name-60","amount":0.4141933192690611},
              {"id":"id-61","name":"name-61","amount":0.2540683364092212},
              {"id":"id-62","name":"name-62","amount":0.7629369354575096},
              {"id":"id-63","name":"name-63","amount":0.2701344713134408},
              {"id":"id-64","name":"name-64","amount":0.10407665001260369},
              {"id":"id-65","name":"name-65","amount":0.042681724841722724},
              {"id":"id-66","name":"name-66","amount":0.14623417532202576},
              {"id":"id-67","name":"name-67","amount":0.11643034810177366},
              {"id":"id-68","name":"name-68","amount":0.262331836500973},
              {"id":"id-69","name":"name-69","amount":0.43701452510472283},
              {"id":"id-70","name":"name-70","amount":0.6397363698257786},
              {"id":"id-71","name":"name-71","amount":0.904447266112362},
              {"id":"id-72","name":"name-72","amount":0.3559989375008602},
              {"id":"id-73","name":"name-73","amount":0.8585529327105277},
              {"id":"id-74","name":"name-74","amount":0.11692260498813944},
              {"id":"id-75","name":"name-75","amount":0.3865279422953478},
              {"id":"id-76","name":"name-76","amount":0.4354871276954255},
              {"id":"id-77","name":"name-77","amount":0.7334960578845064},
              {"id":"id-78","name":"name-78","amount":0.2592746847667935},
              {"id":"id-79","name":"name-79","amount":0.6871525863080652},
              {"id":"id-80","name":"name-80","amount":0.014417468647307974},
              {"id":"id-81","name":"name-81","amount":0.21160368607752789},
              {"id":"id-82","name":"name-82","amount":0.7227968551232853},
              {"id":"id-83","name":"name-83","amount":0.015681606862535835},
              {"id":"id-84","name":"name-84","amount":0.9664613376440245},
              {"id":"id-85","name":"name-85","amount":0.17786468529888355},
              {"id":"id-86","name":"name-86","amount":0.67231541940957},
              {"id":"id-87","name":"name-87","amount":0.5120834839215734},
              {"id":"id-88","name":"name-88","amount":0.8275104064327952},
              {"id":"id-89","name":"name-89","amount":0.47291076501658436},
              {"id":"id-90","name":"name-90","amount":0.6212105824554314},
              {"id":"id-91","name":"name-91","amount":0.06979433217668563},
              {"id":"id-92","name":"name-92","amount":0.15420962966517882},
              {"id":"id-93","name":"name-93","amount":0.32110689014032234},
              {"id":"id-94","name":"name-94","amount":0.7300533971178407},
              {"id":"id-95","name":"name-95","amount":0.14098916523909166},
              {"id":"id-96","name":"name-96","amount":0.008830241348603773},
              {"id":"id-97","name":"name-97","amount":0.454508327823152},
              {"id":"id-98","name":"name-98","amount":0.5896914250658836},
              {"id":"id-99","name":"name-99","amount":0.596926443365038}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

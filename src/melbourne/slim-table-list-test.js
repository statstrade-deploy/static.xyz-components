      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.5781632783307837},
              {"id":"id-1","name":"name-1","amount":0.45520647029764516},
              {"id":"id-2","name":"name-2","amount":0.26877881234768897},
              {"id":"id-3","name":"name-3","amount":0.577698553427747},
              {"id":"id-4","name":"name-4","amount":0.6157538495713342},
              {"id":"id-5","name":"name-5","amount":0.4608774619950893},
              {"id":"id-6","name":"name-6","amount":0.4068426026526989},
              {"id":"id-7","name":"name-7","amount":0.4755287975827951},
              {"id":"id-8","name":"name-8","amount":0.5432648324697197},
              {"id":"id-9","name":"name-9","amount":0.2717333035352366},
              {"id":"id-10","name":"name-10","amount":0.24562204788396758},
              {"id":"id-11","name":"name-11","amount":0.12141586675919702},
              {"id":"id-12","name":"name-12","amount":0.44523016518560077},
              {"id":"id-13","name":"name-13","amount":0.11502688771168557},
              {"id":"id-14","name":"name-14","amount":0.9066484503280092},
              {"id":"id-15","name":"name-15","amount":0.21463443365607393},
              {"id":"id-16","name":"name-16","amount":0.6537837820329648},
              {"id":"id-17","name":"name-17","amount":0.05439668762251437},
              {"id":"id-18","name":"name-18","amount":0.6333275756775757},
              {"id":"id-19","name":"name-19","amount":0.45099753810275667},
              {"id":"id-20","name":"name-20","amount":0.3987580876325354},
              {"id":"id-21","name":"name-21","amount":0.4397968142548163},
              {"id":"id-22","name":"name-22","amount":0.29216047270659795},
              {"id":"id-23","name":"name-23","amount":0.2139274652084644},
              {"id":"id-24","name":"name-24","amount":0.9492498909355814},
              {"id":"id-25","name":"name-25","amount":0.11825047219266982},
              {"id":"id-26","name":"name-26","amount":0.4679250982031491},
              {"id":"id-27","name":"name-27","amount":0.17095755447056893},
              {"id":"id-28","name":"name-28","amount":0.7282517140912276},
              {"id":"id-29","name":"name-29","amount":0.8638309942355994},
              {"id":"id-30","name":"name-30","amount":0.8009204327659534},
              {"id":"id-31","name":"name-31","amount":0.9669793310771129},
              {"id":"id-32","name":"name-32","amount":0.2540167491623062},
              {"id":"id-33","name":"name-33","amount":0.05265822821179278},
              {"id":"id-34","name":"name-34","amount":0.28957049827683345},
              {"id":"id-35","name":"name-35","amount":0.6010578278852823},
              {"id":"id-36","name":"name-36","amount":0.7901458483242371},
              {"id":"id-37","name":"name-37","amount":0.08233004408366829},
              {"id":"id-38","name":"name-38","amount":0.5131302065399623},
              {"id":"id-39","name":"name-39","amount":0.8753950919888629},
              {"id":"id-40","name":"name-40","amount":0.2709555603665873},
              {"id":"id-41","name":"name-41","amount":0.41509228561901856},
              {"id":"id-42","name":"name-42","amount":0.11693127586225915},
              {"id":"id-43","name":"name-43","amount":0.5130302213051975},
              {"id":"id-44","name":"name-44","amount":0.4095060865579917},
              {"id":"id-45","name":"name-45","amount":0.41018265800895937},
              {"id":"id-46","name":"name-46","amount":0.44655101666255337},
              {"id":"id-47","name":"name-47","amount":0.15512173825093412},
              {"id":"id-48","name":"name-48","amount":0.8927391338887593},
              {"id":"id-49","name":"name-49","amount":0.30316753286564124},
              {"id":"id-50","name":"name-50","amount":0.9174823354527115},
              {"id":"id-51","name":"name-51","amount":0.46916619925435143},
              {"id":"id-52","name":"name-52","amount":0.22149470021513828},
              {"id":"id-53","name":"name-53","amount":0.7887224698947222},
              {"id":"id-54","name":"name-54","amount":0.5633288254528479},
              {"id":"id-55","name":"name-55","amount":0.026264513180845772},
              {"id":"id-56","name":"name-56","amount":0.06274761716759625},
              {"id":"id-57","name":"name-57","amount":0.6681914831281254},
              {"id":"id-58","name":"name-58","amount":0.21824376524318556},
              {"id":"id-59","name":"name-59","amount":0.4385553927969552},
              {"id":"id-60","name":"name-60","amount":0.9472237937310841},
              {"id":"id-61","name":"name-61","amount":0.9343914439105572},
              {"id":"id-62","name":"name-62","amount":0.9582773518042191},
              {"id":"id-63","name":"name-63","amount":0.48719308021944885},
              {"id":"id-64","name":"name-64","amount":0.7676269121983217},
              {"id":"id-65","name":"name-65","amount":0.48351166866040063},
              {"id":"id-66","name":"name-66","amount":0.7514918954034375},
              {"id":"id-67","name":"name-67","amount":0.6167544616278605},
              {"id":"id-68","name":"name-68","amount":0.8110269511913573},
              {"id":"id-69","name":"name-69","amount":0.36759154262692795},
              {"id":"id-70","name":"name-70","amount":0.7481497775335977},
              {"id":"id-71","name":"name-71","amount":0.22371827761145657},
              {"id":"id-72","name":"name-72","amount":0.99353125985725},
              {"id":"id-73","name":"name-73","amount":0.13094144337728042},
              {"id":"id-74","name":"name-74","amount":0.27997453905824043},
              {"id":"id-75","name":"name-75","amount":0.6246671927411842},
              {"id":"id-76","name":"name-76","amount":0.5561805594493799},
              {"id":"id-77","name":"name-77","amount":0.3100053373531185},
              {"id":"id-78","name":"name-78","amount":0.43143052549703553},
              {"id":"id-79","name":"name-79","amount":0.45412099802469374},
              {"id":"id-80","name":"name-80","amount":0.7280811518129777},
              {"id":"id-81","name":"name-81","amount":0.6185460672476718},
              {"id":"id-82","name":"name-82","amount":0.9961620385620833},
              {"id":"id-83","name":"name-83","amount":0.5124174196144407},
              {"id":"id-84","name":"name-84","amount":0.7661060736153468},
              {"id":"id-85","name":"name-85","amount":0.6886673616341444},
              {"id":"id-86","name":"name-86","amount":0.7381782421830934},
              {"id":"id-87","name":"name-87","amount":0.760814361675548},
              {"id":"id-88","name":"name-88","amount":0.34006770366700956},
              {"id":"id-89","name":"name-89","amount":0.49306940008077804},
              {"id":"id-90","name":"name-90","amount":0.14006510263091043},
              {"id":"id-91","name":"name-91","amount":0.2439957833266988},
              {"id":"id-92","name":"name-92","amount":0.44808447963102915},
              {"id":"id-93","name":"name-93","amount":0.7350669992884585},
              {"id":"id-94","name":"name-94","amount":0.23945140434296575},
              {"id":"id-95","name":"name-95","amount":0.20942045956152422},
              {"id":"id-96","name":"name-96","amount":0.9189351780349603},
              {"id":"id-97","name":"name-97","amount":0.560283413560089},
              {"id":"id-98","name":"name-98","amount":0.7301508259501379},
              {"id":"id-99","name":"name-99","amount":0.5884617481847594}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.9530584783351196},
              {"id":"id-1","name":"name-1","amount":0.9979155430321318},
              {"id":"id-2","name":"name-2","amount":0.2542800660341432},
              {"id":"id-3","name":"name-3","amount":0.7014815331435863},
              {"id":"id-4","name":"name-4","amount":0.02612369736253295},
              {"id":"id-5","name":"name-5","amount":0.5712151062630481},
              {"id":"id-6","name":"name-6","amount":0.8932987773065044},
              {"id":"id-7","name":"name-7","amount":0.8251847387062288},
              {"id":"id-8","name":"name-8","amount":0.35583519164059196},
              {"id":"id-9","name":"name-9","amount":0.5266195525013497},
              {"id":"id-10","name":"name-10","amount":0.6438661434836993},
              {"id":"id-11","name":"name-11","amount":0.7188281268053698},
              {"id":"id-12","name":"name-12","amount":0.836694100898061},
              {"id":"id-13","name":"name-13","amount":0.5934235704954763},
              {"id":"id-14","name":"name-14","amount":0.21161999899593764},
              {"id":"id-15","name":"name-15","amount":0.19629216412960016},
              {"id":"id-16","name":"name-16","amount":0.6489662445328351},
              {"id":"id-17","name":"name-17","amount":0.6087464448827176},
              {"id":"id-18","name":"name-18","amount":0.8713116765240565},
              {"id":"id-19","name":"name-19","amount":0.5224613371050603},
              {"id":"id-20","name":"name-20","amount":0.08425197800769357},
              {"id":"id-21","name":"name-21","amount":0.5984920785120652},
              {"id":"id-22","name":"name-22","amount":0.6631971495825453},
              {"id":"id-23","name":"name-23","amount":0.7334178024252318},
              {"id":"id-24","name":"name-24","amount":0.2991382979128492},
              {"id":"id-25","name":"name-25","amount":0.1980815010625676},
              {"id":"id-26","name":"name-26","amount":0.08240646534609908},
              {"id":"id-27","name":"name-27","amount":0.7432610937598464},
              {"id":"id-28","name":"name-28","amount":0.4267737579933638},
              {"id":"id-29","name":"name-29","amount":0.9367917118570086},
              {"id":"id-30","name":"name-30","amount":0.27951018947075335},
              {"id":"id-31","name":"name-31","amount":0.7911726950267061},
              {"id":"id-32","name":"name-32","amount":0.44202615860717187},
              {"id":"id-33","name":"name-33","amount":0.8206680211307986},
              {"id":"id-34","name":"name-34","amount":0.9594471790167026},
              {"id":"id-35","name":"name-35","amount":0.021603452844005888},
              {"id":"id-36","name":"name-36","amount":0.7979540192911029},
              {"id":"id-37","name":"name-37","amount":0.4663597710699542},
              {"id":"id-38","name":"name-38","amount":0.491173490093481},
              {"id":"id-39","name":"name-39","amount":0.6359681359848636},
              {"id":"id-40","name":"name-40","amount":0.12964258793799888},
              {"id":"id-41","name":"name-41","amount":0.7618620466275615},
              {"id":"id-42","name":"name-42","amount":0.2218371366821389},
              {"id":"id-43","name":"name-43","amount":0.10599045635868853},
              {"id":"id-44","name":"name-44","amount":0.2560261435275084},
              {"id":"id-45","name":"name-45","amount":0.6600288456744627},
              {"id":"id-46","name":"name-46","amount":0.6269791767548519},
              {"id":"id-47","name":"name-47","amount":0.39684896958926064},
              {"id":"id-48","name":"name-48","amount":0.3011376917788162},
              {"id":"id-49","name":"name-49","amount":0.24685615353590418},
              {"id":"id-50","name":"name-50","amount":0.7222063039614173},
              {"id":"id-51","name":"name-51","amount":0.012532185658289507},
              {"id":"id-52","name":"name-52","amount":0.0032984703887597444},
              {"id":"id-53","name":"name-53","amount":0.6689157431558134},
              {"id":"id-54","name":"name-54","amount":0.11197634568521841},
              {"id":"id-55","name":"name-55","amount":0.9463195390044269},
              {"id":"id-56","name":"name-56","amount":0.18407933680016808},
              {"id":"id-57","name":"name-57","amount":0.8529539083396295},
              {"id":"id-58","name":"name-58","amount":0.15758235411906174},
              {"id":"id-59","name":"name-59","amount":0.29606192398115483},
              {"id":"id-60","name":"name-60","amount":0.9084367293171994},
              {"id":"id-61","name":"name-61","amount":0.2055516028891491},
              {"id":"id-62","name":"name-62","amount":0.009117021661806946},
              {"id":"id-63","name":"name-63","amount":0.38694372457195136},
              {"id":"id-64","name":"name-64","amount":0.08324583271922137},
              {"id":"id-65","name":"name-65","amount":0.6418758381328514},
              {"id":"id-66","name":"name-66","amount":0.6651443327855302},
              {"id":"id-67","name":"name-67","amount":0.7336662411273225},
              {"id":"id-68","name":"name-68","amount":0.1135246304617159},
              {"id":"id-69","name":"name-69","amount":0.3599342862856746},
              {"id":"id-70","name":"name-70","amount":0.7990002776165444},
              {"id":"id-71","name":"name-71","amount":0.06949987340478525},
              {"id":"id-72","name":"name-72","amount":0.7639618558711743},
              {"id":"id-73","name":"name-73","amount":0.7503786784638564},
              {"id":"id-74","name":"name-74","amount":0.822090215399032},
              {"id":"id-75","name":"name-75","amount":0.9714104014409815},
              {"id":"id-76","name":"name-76","amount":0.5579332195335907},
              {"id":"id-77","name":"name-77","amount":0.711784525580094},
              {"id":"id-78","name":"name-78","amount":0.5422458221686286},
              {"id":"id-79","name":"name-79","amount":0.3184724687067232},
              {"id":"id-80","name":"name-80","amount":0.8870093680062292},
              {"id":"id-81","name":"name-81","amount":0.4274685487340776},
              {"id":"id-82","name":"name-82","amount":0.8191492330352755},
              {"id":"id-83","name":"name-83","amount":0.9350412881199609},
              {"id":"id-84","name":"name-84","amount":0.5010308864446266},
              {"id":"id-85","name":"name-85","amount":0.35228669155899917},
              {"id":"id-86","name":"name-86","amount":0.819028200831923},
              {"id":"id-87","name":"name-87","amount":0.29066127338822634},
              {"id":"id-88","name":"name-88","amount":0.2021442746621801},
              {"id":"id-89","name":"name-89","amount":0.7564898560876945},
              {"id":"id-90","name":"name-90","amount":0.8272706506796735},
              {"id":"id-91","name":"name-91","amount":0.05544823755935291},
              {"id":"id-92","name":"name-92","amount":0.37576466963212407},
              {"id":"id-93","name":"name-93","amount":0.678595953226043},
              {"id":"id-94","name":"name-94","amount":0.0903028050760264},
              {"id":"id-95","name":"name-95","amount":0.6426894313330991},
              {"id":"id-96","name":"name-96","amount":0.45725033114717495},
              {"id":"id-97","name":"name-97","amount":0.5503708383829851},
              {"id":"id-98","name":"name-98","amount":0.8270200300707328},
              {"id":"id-99","name":"name-99","amount":0.6096637010800973}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.35420189669390834},
              {"id":"id-1","name":"name-1","amount":0.8394682124002006},
              {"id":"id-2","name":"name-2","amount":0.4867600236598263},
              {"id":"id-3","name":"name-3","amount":0.892575872558712},
              {"id":"id-4","name":"name-4","amount":0.1455461732414728},
              {"id":"id-5","name":"name-5","amount":0.5451551974458783},
              {"id":"id-6","name":"name-6","amount":0.17522120466837754},
              {"id":"id-7","name":"name-7","amount":0.28249260397436093},
              {"id":"id-8","name":"name-8","amount":0.8630274916415239},
              {"id":"id-9","name":"name-9","amount":0.9827610324095253},
              {"id":"id-10","name":"name-10","amount":0.5876126849353309},
              {"id":"id-11","name":"name-11","amount":0.9206684697153368},
              {"id":"id-12","name":"name-12","amount":0.8527742980549293},
              {"id":"id-13","name":"name-13","amount":0.3043993261956308},
              {"id":"id-14","name":"name-14","amount":0.015386004516783958},
              {"id":"id-15","name":"name-15","amount":0.025365509399753683},
              {"id":"id-16","name":"name-16","amount":0.12039245586875302},
              {"id":"id-17","name":"name-17","amount":0.4642441505090691},
              {"id":"id-18","name":"name-18","amount":0.20783535814496823},
              {"id":"id-19","name":"name-19","amount":0.4792068482276328},
              {"id":"id-20","name":"name-20","amount":0.12946966773104496},
              {"id":"id-21","name":"name-21","amount":0.17052670457799457},
              {"id":"id-22","name":"name-22","amount":0.8808400582943348},
              {"id":"id-23","name":"name-23","amount":0.5653899000206029},
              {"id":"id-24","name":"name-24","amount":0.24703453760382377},
              {"id":"id-25","name":"name-25","amount":0.971371673759671},
              {"id":"id-26","name":"name-26","amount":0.9081603623770298},
              {"id":"id-27","name":"name-27","amount":0.7084208278571849},
              {"id":"id-28","name":"name-28","amount":0.23846642977226817},
              {"id":"id-29","name":"name-29","amount":0.1272135744008509},
              {"id":"id-30","name":"name-30","amount":0.7486617450745936},
              {"id":"id-31","name":"name-31","amount":0.964396006103604},
              {"id":"id-32","name":"name-32","amount":0.3051730025312156},
              {"id":"id-33","name":"name-33","amount":0.9586665986894879},
              {"id":"id-34","name":"name-34","amount":0.9567883004819914},
              {"id":"id-35","name":"name-35","amount":0.37011402828025985},
              {"id":"id-36","name":"name-36","amount":0.9054220394927561},
              {"id":"id-37","name":"name-37","amount":0.3011039015785505},
              {"id":"id-38","name":"name-38","amount":0.07380105623553068},
              {"id":"id-39","name":"name-39","amount":0.030809282209582012},
              {"id":"id-40","name":"name-40","amount":0.002035176492858115},
              {"id":"id-41","name":"name-41","amount":0.5458351141795826},
              {"id":"id-42","name":"name-42","amount":0.8037426311003052},
              {"id":"id-43","name":"name-43","amount":0.0030564444537295454},
              {"id":"id-44","name":"name-44","amount":0.4402209874382639},
              {"id":"id-45","name":"name-45","amount":0.5026543478308312},
              {"id":"id-46","name":"name-46","amount":0.1407841996754483},
              {"id":"id-47","name":"name-47","amount":0.6124026271299658},
              {"id":"id-48","name":"name-48","amount":0.8746451531446249},
              {"id":"id-49","name":"name-49","amount":0.9796624626390328},
              {"id":"id-50","name":"name-50","amount":0.03355715297126738},
              {"id":"id-51","name":"name-51","amount":0.834541727595531},
              {"id":"id-52","name":"name-52","amount":0.03690634659275571},
              {"id":"id-53","name":"name-53","amount":0.5436515926399288},
              {"id":"id-54","name":"name-54","amount":0.24726630222049129},
              {"id":"id-55","name":"name-55","amount":0.764353904431751},
              {"id":"id-56","name":"name-56","amount":0.16290588030475206},
              {"id":"id-57","name":"name-57","amount":0.3979718549312643},
              {"id":"id-58","name":"name-58","amount":0.31582690093517407},
              {"id":"id-59","name":"name-59","amount":0.998890079576826},
              {"id":"id-60","name":"name-60","amount":0.08417035497101177},
              {"id":"id-61","name":"name-61","amount":0.6946831451623684},
              {"id":"id-62","name":"name-62","amount":0.8639636055682723},
              {"id":"id-63","name":"name-63","amount":0.968389792480047},
              {"id":"id-64","name":"name-64","amount":0.8280061255781607},
              {"id":"id-65","name":"name-65","amount":0.8839278190293196},
              {"id":"id-66","name":"name-66","amount":0.12315417866148615},
              {"id":"id-67","name":"name-67","amount":0.8636784024052094},
              {"id":"id-68","name":"name-68","amount":0.5684353572299213},
              {"id":"id-69","name":"name-69","amount":0.8958431471450728},
              {"id":"id-70","name":"name-70","amount":0.16549625681420754},
              {"id":"id-71","name":"name-71","amount":0.8287972647534971},
              {"id":"id-72","name":"name-72","amount":0.42318324442066724},
              {"id":"id-73","name":"name-73","amount":0.048964561440349885},
              {"id":"id-74","name":"name-74","amount":0.2360210247273382},
              {"id":"id-75","name":"name-75","amount":0.514478543540904},
              {"id":"id-76","name":"name-76","amount":0.9015563879529598},
              {"id":"id-77","name":"name-77","amount":0.5839542245858884},
              {"id":"id-78","name":"name-78","amount":0.5766728579370936},
              {"id":"id-79","name":"name-79","amount":0.9210840794989553},
              {"id":"id-80","name":"name-80","amount":0.7738732139741595},
              {"id":"id-81","name":"name-81","amount":0.6326216676007766},
              {"id":"id-82","name":"name-82","amount":0.3041188759542184},
              {"id":"id-83","name":"name-83","amount":0.6988853159781929},
              {"id":"id-84","name":"name-84","amount":0.7551764147667361},
              {"id":"id-85","name":"name-85","amount":0.24958674762713529},
              {"id":"id-86","name":"name-86","amount":0.22874844898522806},
              {"id":"id-87","name":"name-87","amount":0.7190695273866429},
              {"id":"id-88","name":"name-88","amount":0.6742791464093647},
              {"id":"id-89","name":"name-89","amount":0.8575672359946743},
              {"id":"id-90","name":"name-90","amount":0.9836673281241798},
              {"id":"id-91","name":"name-91","amount":0.780615096581124},
              {"id":"id-92","name":"name-92","amount":0.7337658294179141},
              {"id":"id-93","name":"name-93","amount":0.08715668308214963},
              {"id":"id-94","name":"name-94","amount":0.4701866497553472},
              {"id":"id-95","name":"name-95","amount":0.7761863617267537},
              {"id":"id-96","name":"name-96","amount":0.05738945453464461},
              {"id":"id-97","name":"name-97","amount":0.5280907051415934},
              {"id":"id-98","name":"name-98","amount":0.4202526313235402},
              {"id":"id-99","name":"name-99","amount":0.504456629451676}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

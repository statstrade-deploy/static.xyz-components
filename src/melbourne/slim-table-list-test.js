      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.9317454560052103},
              {"id":"id-1","name":"name-1","amount":0.3941106871115263},
              {"id":"id-2","name":"name-2","amount":0.17079152951609067},
              {"id":"id-3","name":"name-3","amount":0.4389574204547516},
              {"id":"id-4","name":"name-4","amount":0.2607184077526491},
              {"id":"id-5","name":"name-5","amount":0.7068765020286983},
              {"id":"id-6","name":"name-6","amount":0.42934081836436566},
              {"id":"id-7","name":"name-7","amount":0.4010073815130617},
              {"id":"id-8","name":"name-8","amount":0.8915427964134517},
              {"id":"id-9","name":"name-9","amount":0.878755709558401},
              {"id":"id-10","name":"name-10","amount":0.9547756587105035},
              {"id":"id-11","name":"name-11","amount":0.29426248057051796},
              {"id":"id-12","name":"name-12","amount":0.6736444236169086},
              {"id":"id-13","name":"name-13","amount":0.905139065167459},
              {"id":"id-14","name":"name-14","amount":0.867465732592392},
              {"id":"id-15","name":"name-15","amount":0.54183995865705},
              {"id":"id-16","name":"name-16","amount":0.16047847659912606},
              {"id":"id-17","name":"name-17","amount":0.7910265882244913},
              {"id":"id-18","name":"name-18","amount":0.9022997350120976},
              {"id":"id-19","name":"name-19","amount":0.8752489570022532},
              {"id":"id-20","name":"name-20","amount":0.36940325795708806},
              {"id":"id-21","name":"name-21","amount":0.8024625948869863},
              {"id":"id-22","name":"name-22","amount":0.1706502241255976},
              {"id":"id-23","name":"name-23","amount":0.15815643613012353},
              {"id":"id-24","name":"name-24","amount":0.8056314208595129},
              {"id":"id-25","name":"name-25","amount":0.4836730942393018},
              {"id":"id-26","name":"name-26","amount":0.5188283046247933},
              {"id":"id-27","name":"name-27","amount":0.8557535936779566},
              {"id":"id-28","name":"name-28","amount":0.011030903997216734},
              {"id":"id-29","name":"name-29","amount":0.39916429375587037},
              {"id":"id-30","name":"name-30","amount":0.9083518006194854},
              {"id":"id-31","name":"name-31","amount":0.6368135922933476},
              {"id":"id-32","name":"name-32","amount":0.7354625043909128},
              {"id":"id-33","name":"name-33","amount":0.9360181407856002},
              {"id":"id-34","name":"name-34","amount":0.2208892650692147},
              {"id":"id-35","name":"name-35","amount":0.7371332387091539},
              {"id":"id-36","name":"name-36","amount":0.1965050980603632},
              {"id":"id-37","name":"name-37","amount":0.6588468176105688},
              {"id":"id-38","name":"name-38","amount":0.899531659372236},
              {"id":"id-39","name":"name-39","amount":0.13590300521412146},
              {"id":"id-40","name":"name-40","amount":0.7928330228036778},
              {"id":"id-41","name":"name-41","amount":0.6483449799860436},
              {"id":"id-42","name":"name-42","amount":0.8780821799636608},
              {"id":"id-43","name":"name-43","amount":0.30065081447671205},
              {"id":"id-44","name":"name-44","amount":0.06717507069491646},
              {"id":"id-45","name":"name-45","amount":0.9741051206290338},
              {"id":"id-46","name":"name-46","amount":0.3213440584277466},
              {"id":"id-47","name":"name-47","amount":0.24175728499476257},
              {"id":"id-48","name":"name-48","amount":0.6766975774230686},
              {"id":"id-49","name":"name-49","amount":0.9533376902843551},
              {"id":"id-50","name":"name-50","amount":0.8019251597079866},
              {"id":"id-51","name":"name-51","amount":0.8841409751249591},
              {"id":"id-52","name":"name-52","amount":0.6218190708643628},
              {"id":"id-53","name":"name-53","amount":0.12936460754532664},
              {"id":"id-54","name":"name-54","amount":0.6728671326251088},
              {"id":"id-55","name":"name-55","amount":0.31156425090272144},
              {"id":"id-56","name":"name-56","amount":0.008877499541444012},
              {"id":"id-57","name":"name-57","amount":0.9672310444246056},
              {"id":"id-58","name":"name-58","amount":0.5604462049245122},
              {"id":"id-59","name":"name-59","amount":0.2681117995440212},
              {"id":"id-60","name":"name-60","amount":0.17773522943516962},
              {"id":"id-61","name":"name-61","amount":0.10850691593942297},
              {"id":"id-62","name":"name-62","amount":0.09778146309322089},
              {"id":"id-63","name":"name-63","amount":0.4117452467827911},
              {"id":"id-64","name":"name-64","amount":0.1123210597218719},
              {"id":"id-65","name":"name-65","amount":0.6533263137934451},
              {"id":"id-66","name":"name-66","amount":0.24742558378762725},
              {"id":"id-67","name":"name-67","amount":0.2064389163490571},
              {"id":"id-68","name":"name-68","amount":0.6702726730271764},
              {"id":"id-69","name":"name-69","amount":0.3449395211512438},
              {"id":"id-70","name":"name-70","amount":0.8199025932052375},
              {"id":"id-71","name":"name-71","amount":0.01225386646276505},
              {"id":"id-72","name":"name-72","amount":0.3172567864843424},
              {"id":"id-73","name":"name-73","amount":0.7205287639527103},
              {"id":"id-74","name":"name-74","amount":0.08519508794214647},
              {"id":"id-75","name":"name-75","amount":0.8868078799450766},
              {"id":"id-76","name":"name-76","amount":0.7322086109232973},
              {"id":"id-77","name":"name-77","amount":0.26176547930253347},
              {"id":"id-78","name":"name-78","amount":0.695473911250263},
              {"id":"id-79","name":"name-79","amount":0.8469514986997462},
              {"id":"id-80","name":"name-80","amount":0.8616460287159629},
              {"id":"id-81","name":"name-81","amount":0.3295635833917676},
              {"id":"id-82","name":"name-82","amount":0.4899009989124037},
              {"id":"id-83","name":"name-83","amount":0.856061633770282},
              {"id":"id-84","name":"name-84","amount":0.7443780453326159},
              {"id":"id-85","name":"name-85","amount":0.19970944882155683},
              {"id":"id-86","name":"name-86","amount":0.13612602578176392},
              {"id":"id-87","name":"name-87","amount":0.6002153896838545},
              {"id":"id-88","name":"name-88","amount":0.7023412574996695},
              {"id":"id-89","name":"name-89","amount":0.829526216393857},
              {"id":"id-90","name":"name-90","amount":0.978136363832981},
              {"id":"id-91","name":"name-91","amount":0.19560876804790817},
              {"id":"id-92","name":"name-92","amount":0.2989619692647052},
              {"id":"id-93","name":"name-93","amount":0.08045641771294565},
              {"id":"id-94","name":"name-94","amount":0.9064086441181755},
              {"id":"id-95","name":"name-95","amount":0.32993634045169207},
              {"id":"id-96","name":"name-96","amount":0.8033558766243852},
              {"id":"id-97","name":"name-97","amount":0.997423432263861},
              {"id":"id-98","name":"name-98","amount":0.5438494347548007},
              {"id":"id-99","name":"name-99","amount":0.9820493261831134}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

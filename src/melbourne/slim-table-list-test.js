      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.6521197876627831},
              {"id":"id-1","name":"name-1","amount":0.24114941260207767},
              {"id":"id-2","name":"name-2","amount":0.7807469601368173},
              {"id":"id-3","name":"name-3","amount":0.012934209052362866},
              {"id":"id-4","name":"name-4","amount":0.8628060683434078},
              {"id":"id-5","name":"name-5","amount":0.21994564001132466},
              {"id":"id-6","name":"name-6","amount":0.4902371830410557},
              {"id":"id-7","name":"name-7","amount":0.7242420557026499},
              {"id":"id-8","name":"name-8","amount":0.9981658048566695},
              {"id":"id-9","name":"name-9","amount":0.5028539431388844},
              {"id":"id-10","name":"name-10","amount":0.2645282548410781},
              {"id":"id-11","name":"name-11","amount":0.4678281186424884},
              {"id":"id-12","name":"name-12","amount":0.055435129993964716},
              {"id":"id-13","name":"name-13","amount":0.27178307179713024},
              {"id":"id-14","name":"name-14","amount":0.1016290335565938},
              {"id":"id-15","name":"name-15","amount":0.5737243128944985},
              {"id":"id-16","name":"name-16","amount":0.6117215747413357},
              {"id":"id-17","name":"name-17","amount":0.9153790224213608},
              {"id":"id-18","name":"name-18","amount":0.16312800170195085},
              {"id":"id-19","name":"name-19","amount":0.25507230018392435},
              {"id":"id-20","name":"name-20","amount":0.7846069911733486},
              {"id":"id-21","name":"name-21","amount":0.7235959726558671},
              {"id":"id-22","name":"name-22","amount":0.993536304134257},
              {"id":"id-23","name":"name-23","amount":0.8446568709902865},
              {"id":"id-24","name":"name-24","amount":0.7806117016394195},
              {"id":"id-25","name":"name-25","amount":0.23199522421702135},
              {"id":"id-26","name":"name-26","amount":0.2642745642390364},
              {"id":"id-27","name":"name-27","amount":0.20742722765741295},
              {"id":"id-28","name":"name-28","amount":0.4522044916504996},
              {"id":"id-29","name":"name-29","amount":0.34080235012196447},
              {"id":"id-30","name":"name-30","amount":0.24863300538109445},
              {"id":"id-31","name":"name-31","amount":0.19671284180938486},
              {"id":"id-32","name":"name-32","amount":0.3006447501962838},
              {"id":"id-33","name":"name-33","amount":0.57691741589183},
              {"id":"id-34","name":"name-34","amount":0.2662607586211855},
              {"id":"id-35","name":"name-35","amount":0.9056293213083397},
              {"id":"id-36","name":"name-36","amount":0.659794936138171},
              {"id":"id-37","name":"name-37","amount":0.6414865945666177},
              {"id":"id-38","name":"name-38","amount":0.14921671330959008},
              {"id":"id-39","name":"name-39","amount":0.38020832611928834},
              {"id":"id-40","name":"name-40","amount":0.3751426442556164},
              {"id":"id-41","name":"name-41","amount":0.69130812139174},
              {"id":"id-42","name":"name-42","amount":0.37634111763556044},
              {"id":"id-43","name":"name-43","amount":0.40707543432746784},
              {"id":"id-44","name":"name-44","amount":0.15262352840332705},
              {"id":"id-45","name":"name-45","amount":0.6392593092960137},
              {"id":"id-46","name":"name-46","amount":0.8986832886531714},
              {"id":"id-47","name":"name-47","amount":0.9660381628657804},
              {"id":"id-48","name":"name-48","amount":0.8934374835292599},
              {"id":"id-49","name":"name-49","amount":0.12709540326569224},
              {"id":"id-50","name":"name-50","amount":0.8359479444518042},
              {"id":"id-51","name":"name-51","amount":0.946736161892775},
              {"id":"id-52","name":"name-52","amount":0.7539024768398015},
              {"id":"id-53","name":"name-53","amount":0.7233852116151035},
              {"id":"id-54","name":"name-54","amount":0.1623984259063289},
              {"id":"id-55","name":"name-55","amount":0.7685436787622768},
              {"id":"id-56","name":"name-56","amount":0.37349174616156755},
              {"id":"id-57","name":"name-57","amount":0.33001232753137766},
              {"id":"id-58","name":"name-58","amount":0.2203825163684171},
              {"id":"id-59","name":"name-59","amount":0.6142046610507036},
              {"id":"id-60","name":"name-60","amount":0.6995515253993272},
              {"id":"id-61","name":"name-61","amount":0.7425853435064285},
              {"id":"id-62","name":"name-62","amount":0.4006224909966405},
              {"id":"id-63","name":"name-63","amount":0.09021883800665909},
              {"id":"id-64","name":"name-64","amount":0.10379841525800027},
              {"id":"id-65","name":"name-65","amount":0.8032635589919215},
              {"id":"id-66","name":"name-66","amount":0.6106377130467686},
              {"id":"id-67","name":"name-67","amount":0.26078677957075247},
              {"id":"id-68","name":"name-68","amount":0.03354659137432425},
              {"id":"id-69","name":"name-69","amount":0.6089198939034405},
              {"id":"id-70","name":"name-70","amount":0.21614499101199647},
              {"id":"id-71","name":"name-71","amount":0.16716101680526563},
              {"id":"id-72","name":"name-72","amount":0.26971703473116604},
              {"id":"id-73","name":"name-73","amount":0.7932258155286692},
              {"id":"id-74","name":"name-74","amount":0.9850080494402335},
              {"id":"id-75","name":"name-75","amount":0.14053890658023604},
              {"id":"id-76","name":"name-76","amount":0.9740323607861024},
              {"id":"id-77","name":"name-77","amount":0.9881577892514354},
              {"id":"id-78","name":"name-78","amount":0.1892843823816811},
              {"id":"id-79","name":"name-79","amount":0.4441726609113197},
              {"id":"id-80","name":"name-80","amount":0.09940210587414444},
              {"id":"id-81","name":"name-81","amount":0.18858830267293392},
              {"id":"id-82","name":"name-82","amount":0.42814376790349007},
              {"id":"id-83","name":"name-83","amount":0.03916011052294288},
              {"id":"id-84","name":"name-84","amount":0.4103555601247698},
              {"id":"id-85","name":"name-85","amount":0.8930393170826396},
              {"id":"id-86","name":"name-86","amount":0.9229102389374391},
              {"id":"id-87","name":"name-87","amount":0.5584201328138496},
              {"id":"id-88","name":"name-88","amount":0.3144800311799748},
              {"id":"id-89","name":"name-89","amount":0.5743391342755713},
              {"id":"id-90","name":"name-90","amount":0.005204813227278948},
              {"id":"id-91","name":"name-91","amount":0.894644165135235},
              {"id":"id-92","name":"name-92","amount":0.9411745987323099},
              {"id":"id-93","name":"name-93","amount":0.24583825967353312},
              {"id":"id-94","name":"name-94","amount":0.2701434788026017},
              {"id":"id-95","name":"name-95","amount":0.16055579071754356},
              {"id":"id-96","name":"name-96","amount":0.4206307262445078},
              {"id":"id-97","name":"name-97","amount":0.6320043895684622},
              {"id":"id-98","name":"name-98","amount":0.39877142704004387},
              {"id":"id-99","name":"name-99","amount":0.16359830465479996}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

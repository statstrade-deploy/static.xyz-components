      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.5235072070109891},
              {"id":"id-1","name":"name-1","amount":0.4171177490499164},
              {"id":"id-2","name":"name-2","amount":0.07737455356999834},
              {"id":"id-3","name":"name-3","amount":0.0697973353915563},
              {"id":"id-4","name":"name-4","amount":0.5884001506827712},
              {"id":"id-5","name":"name-5","amount":0.4253509527635634},
              {"id":"id-6","name":"name-6","amount":0.21286086138996507},
              {"id":"id-7","name":"name-7","amount":0.7038653373604411},
              {"id":"id-8","name":"name-8","amount":0.553808371407407},
              {"id":"id-9","name":"name-9","amount":0.9550389949324789},
              {"id":"id-10","name":"name-10","amount":0.659027806068793},
              {"id":"id-11","name":"name-11","amount":0.6939774398144029},
              {"id":"id-12","name":"name-12","amount":0.41304253211421194},
              {"id":"id-13","name":"name-13","amount":0.38902615278374575},
              {"id":"id-14","name":"name-14","amount":0.07908881946534874},
              {"id":"id-15","name":"name-15","amount":0.8377948584330875},
              {"id":"id-16","name":"name-16","amount":0.8390132331447675},
              {"id":"id-17","name":"name-17","amount":0.7263338578623386},
              {"id":"id-18","name":"name-18","amount":0.9027285252892305},
              {"id":"id-19","name":"name-19","amount":0.2800294560519594},
              {"id":"id-20","name":"name-20","amount":0.017518776557074123},
              {"id":"id-21","name":"name-21","amount":0.23182076049250777},
              {"id":"id-22","name":"name-22","amount":0.10755901022893255},
              {"id":"id-23","name":"name-23","amount":0.030563843527551482},
              {"id":"id-24","name":"name-24","amount":0.8750768685484919},
              {"id":"id-25","name":"name-25","amount":0.5446639889992251},
              {"id":"id-26","name":"name-26","amount":0.7593314956935184},
              {"id":"id-27","name":"name-27","amount":0.5664692617508831},
              {"id":"id-28","name":"name-28","amount":0.8938349372456705},
              {"id":"id-29","name":"name-29","amount":0.35250389065132914},
              {"id":"id-30","name":"name-30","amount":0.04494334630290875},
              {"id":"id-31","name":"name-31","amount":0.732673069804391},
              {"id":"id-32","name":"name-32","amount":0.828165691841577},
              {"id":"id-33","name":"name-33","amount":0.055476803856579604},
              {"id":"id-34","name":"name-34","amount":0.35747428460412145},
              {"id":"id-35","name":"name-35","amount":0.30153622718543527},
              {"id":"id-36","name":"name-36","amount":0.4158730337373061},
              {"id":"id-37","name":"name-37","amount":0.06799381783718184},
              {"id":"id-38","name":"name-38","amount":0.973932521025133},
              {"id":"id-39","name":"name-39","amount":0.10335817541735026},
              {"id":"id-40","name":"name-40","amount":0.6115053949107483},
              {"id":"id-41","name":"name-41","amount":0.5360057171624999},
              {"id":"id-42","name":"name-42","amount":0.004085442351581925},
              {"id":"id-43","name":"name-43","amount":0.5978351552832669},
              {"id":"id-44","name":"name-44","amount":0.9600927497965075},
              {"id":"id-45","name":"name-45","amount":0.2836277682994116},
              {"id":"id-46","name":"name-46","amount":0.5826957166284231},
              {"id":"id-47","name":"name-47","amount":0.12075518561052212},
              {"id":"id-48","name":"name-48","amount":0.4766943203642753},
              {"id":"id-49","name":"name-49","amount":0.7453800611557256},
              {"id":"id-50","name":"name-50","amount":0.7276785612678304},
              {"id":"id-51","name":"name-51","amount":0.8107208684750538},
              {"id":"id-52","name":"name-52","amount":0.8004643581694033},
              {"id":"id-53","name":"name-53","amount":0.4889325420542354},
              {"id":"id-54","name":"name-54","amount":0.8931415257452434},
              {"id":"id-55","name":"name-55","amount":0.39744947155443755},
              {"id":"id-56","name":"name-56","amount":0.45151346112897917},
              {"id":"id-57","name":"name-57","amount":0.6881264156090117},
              {"id":"id-58","name":"name-58","amount":0.008963030075972767},
              {"id":"id-59","name":"name-59","amount":0.6162066873039116},
              {"id":"id-60","name":"name-60","amount":0.7346635011143063},
              {"id":"id-61","name":"name-61","amount":0.5671765479824364},
              {"id":"id-62","name":"name-62","amount":0.7175115952036597},
              {"id":"id-63","name":"name-63","amount":0.002189165202242216},
              {"id":"id-64","name":"name-64","amount":0.20626413454764148},
              {"id":"id-65","name":"name-65","amount":0.4043420087139251},
              {"id":"id-66","name":"name-66","amount":0.5933030839120481},
              {"id":"id-67","name":"name-67","amount":0.21417812396162383},
              {"id":"id-68","name":"name-68","amount":0.6485596662738953},
              {"id":"id-69","name":"name-69","amount":0.15698509011867168},
              {"id":"id-70","name":"name-70","amount":0.3628378342534845},
              {"id":"id-71","name":"name-71","amount":0.8385443849979582},
              {"id":"id-72","name":"name-72","amount":0.18066493400627726},
              {"id":"id-73","name":"name-73","amount":0.1498218798665114},
              {"id":"id-74","name":"name-74","amount":0.5295561578930956},
              {"id":"id-75","name":"name-75","amount":0.8326930580393561},
              {"id":"id-76","name":"name-76","amount":0.47602935183349493},
              {"id":"id-77","name":"name-77","amount":0.5542997635694565},
              {"id":"id-78","name":"name-78","amount":0.35279467383675445},
              {"id":"id-79","name":"name-79","amount":0.38129363099411884},
              {"id":"id-80","name":"name-80","amount":0.05333887939261206},
              {"id":"id-81","name":"name-81","amount":0.5794209924790871},
              {"id":"id-82","name":"name-82","amount":0.8298220029059964},
              {"id":"id-83","name":"name-83","amount":0.9591494866918878},
              {"id":"id-84","name":"name-84","amount":0.26112509744918},
              {"id":"id-85","name":"name-85","amount":0.39296332886166174},
              {"id":"id-86","name":"name-86","amount":0.18647774803268202},
              {"id":"id-87","name":"name-87","amount":0.8213182348241939},
              {"id":"id-88","name":"name-88","amount":0.8859221831507105},
              {"id":"id-89","name":"name-89","amount":0.796932220447804},
              {"id":"id-90","name":"name-90","amount":0.3946334299703954},
              {"id":"id-91","name":"name-91","amount":0.9741022282617471},
              {"id":"id-92","name":"name-92","amount":0.27963169526516685},
              {"id":"id-93","name":"name-93","amount":0.5922114074463272},
              {"id":"id-94","name":"name-94","amount":0.4036398956953554},
              {"id":"id-95","name":"name-95","amount":0.919786617967868},
              {"id":"id-96","name":"name-96","amount":0.5238259034103839},
              {"id":"id-97","name":"name-97","amount":0.38476191049130204},
              {"id":"id-98","name":"name-98","amount":0.09812061123674665},
              {"id":"id-99","name":"name-99","amount":0.11350984292563215}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

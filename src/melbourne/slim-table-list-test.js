      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.2648685958089123},
              {"id":"id-1","name":"name-1","amount":0.87698085496144},
              {"id":"id-2","name":"name-2","amount":0.6411848491104324},
              {"id":"id-3","name":"name-3","amount":0.9467322278492775},
              {"id":"id-4","name":"name-4","amount":0.10335640176412442},
              {"id":"id-5","name":"name-5","amount":0.15749486354378073},
              {"id":"id-6","name":"name-6","amount":0.4117862904795846},
              {"id":"id-7","name":"name-7","amount":0.21779667008880566},
              {"id":"id-8","name":"name-8","amount":0.5450589001005084},
              {"id":"id-9","name":"name-9","amount":0.3390245828681423},
              {"id":"id-10","name":"name-10","amount":0.005169425710833453},
              {"id":"id-11","name":"name-11","amount":0.748444492923117},
              {"id":"id-12","name":"name-12","amount":0.013946486359497134},
              {"id":"id-13","name":"name-13","amount":0.9499655895918955},
              {"id":"id-14","name":"name-14","amount":0.9164052422413096},
              {"id":"id-15","name":"name-15","amount":0.6743192468864591},
              {"id":"id-16","name":"name-16","amount":0.8433304700003856},
              {"id":"id-17","name":"name-17","amount":0.394912885330979},
              {"id":"id-18","name":"name-18","amount":0.36610140228944466},
              {"id":"id-19","name":"name-19","amount":0.38750554616033095},
              {"id":"id-20","name":"name-20","amount":0.4049579969410688},
              {"id":"id-21","name":"name-21","amount":0.9296686670114631},
              {"id":"id-22","name":"name-22","amount":0.1340129886024637},
              {"id":"id-23","name":"name-23","amount":0.0465010557442741},
              {"id":"id-24","name":"name-24","amount":0.6219081464762748},
              {"id":"id-25","name":"name-25","amount":0.4671419778396655},
              {"id":"id-26","name":"name-26","amount":0.7187916025646643},
              {"id":"id-27","name":"name-27","amount":0.24528141873757137},
              {"id":"id-28","name":"name-28","amount":0.464075031401862},
              {"id":"id-29","name":"name-29","amount":0.9772317589083154},
              {"id":"id-30","name":"name-30","amount":0.46416238991408865},
              {"id":"id-31","name":"name-31","amount":0.2124602323149265},
              {"id":"id-32","name":"name-32","amount":0.1470934288303073},
              {"id":"id-33","name":"name-33","amount":0.561168708251405},
              {"id":"id-34","name":"name-34","amount":0.11701341162826284},
              {"id":"id-35","name":"name-35","amount":0.05705417766278431},
              {"id":"id-36","name":"name-36","amount":0.5338830698249871},
              {"id":"id-37","name":"name-37","amount":0.5044229280158938},
              {"id":"id-38","name":"name-38","amount":0.26432746968459375},
              {"id":"id-39","name":"name-39","amount":0.12912111199427256},
              {"id":"id-40","name":"name-40","amount":0.6725577433942811},
              {"id":"id-41","name":"name-41","amount":0.7421686081245077},
              {"id":"id-42","name":"name-42","amount":0.23358140025004848},
              {"id":"id-43","name":"name-43","amount":0.5215466080006929},
              {"id":"id-44","name":"name-44","amount":0.49526618057658034},
              {"id":"id-45","name":"name-45","amount":0.2074283833262074},
              {"id":"id-46","name":"name-46","amount":0.3351835846344635},
              {"id":"id-47","name":"name-47","amount":0.10351268867367558},
              {"id":"id-48","name":"name-48","amount":0.44960122095371724},
              {"id":"id-49","name":"name-49","amount":0.47440379978172464},
              {"id":"id-50","name":"name-50","amount":0.7757155258372838},
              {"id":"id-51","name":"name-51","amount":0.24668960990867694},
              {"id":"id-52","name":"name-52","amount":0.2375350667900229},
              {"id":"id-53","name":"name-53","amount":0.9581308269217277},
              {"id":"id-54","name":"name-54","amount":0.17718857058909554},
              {"id":"id-55","name":"name-55","amount":0.5819502910957449},
              {"id":"id-56","name":"name-56","amount":0.8964078185203678},
              {"id":"id-57","name":"name-57","amount":0.6864819211515215},
              {"id":"id-58","name":"name-58","amount":0.4002223426462851},
              {"id":"id-59","name":"name-59","amount":0.7074135852213056},
              {"id":"id-60","name":"name-60","amount":0.17231729736323198},
              {"id":"id-61","name":"name-61","amount":0.32166938610516094},
              {"id":"id-62","name":"name-62","amount":0.287996701001199},
              {"id":"id-63","name":"name-63","amount":0.7578818875248382},
              {"id":"id-64","name":"name-64","amount":0.5083285337689615},
              {"id":"id-65","name":"name-65","amount":0.6757874278759021},
              {"id":"id-66","name":"name-66","amount":0.023024314842221116},
              {"id":"id-67","name":"name-67","amount":0.14124485362848715},
              {"id":"id-68","name":"name-68","amount":0.998241085217261},
              {"id":"id-69","name":"name-69","amount":0.43856265609112155},
              {"id":"id-70","name":"name-70","amount":0.02023625553818842},
              {"id":"id-71","name":"name-71","amount":0.5491801053434235},
              {"id":"id-72","name":"name-72","amount":0.34122351050494504},
              {"id":"id-73","name":"name-73","amount":0.2153666657010055},
              {"id":"id-74","name":"name-74","amount":0.667568478740026},
              {"id":"id-75","name":"name-75","amount":0.5574886786593001},
              {"id":"id-76","name":"name-76","amount":0.17344366636535435},
              {"id":"id-77","name":"name-77","amount":0.25967589051070916},
              {"id":"id-78","name":"name-78","amount":0.7691820661394275},
              {"id":"id-79","name":"name-79","amount":0.7456613837362338},
              {"id":"id-80","name":"name-80","amount":0.14989456741216878},
              {"id":"id-81","name":"name-81","amount":0.476547647955992},
              {"id":"id-82","name":"name-82","amount":0.2466457936916041},
              {"id":"id-83","name":"name-83","amount":0.2857797870542774},
              {"id":"id-84","name":"name-84","amount":0.8029356648924377},
              {"id":"id-85","name":"name-85","amount":0.37231373833314607},
              {"id":"id-86","name":"name-86","amount":0.5098544861792683},
              {"id":"id-87","name":"name-87","amount":0.37761330882040534},
              {"id":"id-88","name":"name-88","amount":0.5136392539210797},
              {"id":"id-89","name":"name-89","amount":0.6305758938835373},
              {"id":"id-90","name":"name-90","amount":0.9221524056005},
              {"id":"id-91","name":"name-91","amount":0.7397819691887857},
              {"id":"id-92","name":"name-92","amount":0.8978528028679916},
              {"id":"id-93","name":"name-93","amount":0.9057197507199899},
              {"id":"id-94","name":"name-94","amount":0.9530757552599691},
              {"id":"id-95","name":"name-95","amount":0.6061116909445661},
              {"id":"id-96","name":"name-96","amount":0.5309577642806931},
              {"id":"id-97","name":"name-97","amount":0.24254785122332},
              {"id":"id-98","name":"name-98","amount":0.9373240209681781},
              {"id":"id-99","name":"name-99","amount":0.3218177260866608}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

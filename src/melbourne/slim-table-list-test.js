      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.3445713045289135},
              {"id":"id-1","name":"name-1","amount":0.721972718078298},
              {"id":"id-2","name":"name-2","amount":0.8970254028816098},
              {"id":"id-3","name":"name-3","amount":0.014000051480025588},
              {"id":"id-4","name":"name-4","amount":0.10825380451080291},
              {"id":"id-5","name":"name-5","amount":0.5926280053071985},
              {"id":"id-6","name":"name-6","amount":0.592448364581149},
              {"id":"id-7","name":"name-7","amount":0.9791801061646511},
              {"id":"id-8","name":"name-8","amount":0.27031240062007367},
              {"id":"id-9","name":"name-9","amount":0.6021436388048687},
              {"id":"id-10","name":"name-10","amount":0.7696217127079522},
              {"id":"id-11","name":"name-11","amount":0.3136352506295188},
              {"id":"id-12","name":"name-12","amount":0.06184240775872529},
              {"id":"id-13","name":"name-13","amount":0.8413583512041757},
              {"id":"id-14","name":"name-14","amount":0.7781864017703597},
              {"id":"id-15","name":"name-15","amount":0.2853359808897742},
              {"id":"id-16","name":"name-16","amount":0.9461267600210703},
              {"id":"id-17","name":"name-17","amount":0.983977675891283},
              {"id":"id-18","name":"name-18","amount":0.59476592874976},
              {"id":"id-19","name":"name-19","amount":0.21710916095983857},
              {"id":"id-20","name":"name-20","amount":0.9595890058410588},
              {"id":"id-21","name":"name-21","amount":0.11356045000872905},
              {"id":"id-22","name":"name-22","amount":0.42970484068499937},
              {"id":"id-23","name":"name-23","amount":0.6324994584242477},
              {"id":"id-24","name":"name-24","amount":0.11996973579859471},
              {"id":"id-25","name":"name-25","amount":0.7012631637133832},
              {"id":"id-26","name":"name-26","amount":0.10331671175118484},
              {"id":"id-27","name":"name-27","amount":0.14395655988758538},
              {"id":"id-28","name":"name-28","amount":0.1327140325114482},
              {"id":"id-29","name":"name-29","amount":0.31615986966512977},
              {"id":"id-30","name":"name-30","amount":0.7356172498923417},
              {"id":"id-31","name":"name-31","amount":0.7789353094695083},
              {"id":"id-32","name":"name-32","amount":0.13534687703569748},
              {"id":"id-33","name":"name-33","amount":0.5728064090348189},
              {"id":"id-34","name":"name-34","amount":0.692932226303482},
              {"id":"id-35","name":"name-35","amount":0.8779724803909804},
              {"id":"id-36","name":"name-36","amount":0.7596517094627966},
              {"id":"id-37","name":"name-37","amount":0.02482032703351944},
              {"id":"id-38","name":"name-38","amount":0.6654347426583008},
              {"id":"id-39","name":"name-39","amount":0.918530533412079},
              {"id":"id-40","name":"name-40","amount":0.36275720514436627},
              {"id":"id-41","name":"name-41","amount":0.19859816777751405},
              {"id":"id-42","name":"name-42","amount":0.21157923403143375},
              {"id":"id-43","name":"name-43","amount":0.6193752278138248},
              {"id":"id-44","name":"name-44","amount":0.8807758864702234},
              {"id":"id-45","name":"name-45","amount":0.727894534179389},
              {"id":"id-46","name":"name-46","amount":0.09856470739296253},
              {"id":"id-47","name":"name-47","amount":0.46248021155715247},
              {"id":"id-48","name":"name-48","amount":0.39242776795213874},
              {"id":"id-49","name":"name-49","amount":0.5978380074547807},
              {"id":"id-50","name":"name-50","amount":0.29237310245108916},
              {"id":"id-51","name":"name-51","amount":0.33292908320703096},
              {"id":"id-52","name":"name-52","amount":0.14512028142677802},
              {"id":"id-53","name":"name-53","amount":0.8360610955180966},
              {"id":"id-54","name":"name-54","amount":0.5065932392130397},
              {"id":"id-55","name":"name-55","amount":0.3220108940454758},
              {"id":"id-56","name":"name-56","amount":0.4922463165032521},
              {"id":"id-57","name":"name-57","amount":0.5989727487474432},
              {"id":"id-58","name":"name-58","amount":0.8061543050466513},
              {"id":"id-59","name":"name-59","amount":0.8646825933214745},
              {"id":"id-60","name":"name-60","amount":0.9179996765024131},
              {"id":"id-61","name":"name-61","amount":0.4928035841022036},
              {"id":"id-62","name":"name-62","amount":0.880257542935727},
              {"id":"id-63","name":"name-63","amount":0.2897978918165106},
              {"id":"id-64","name":"name-64","amount":0.08479761213561532},
              {"id":"id-65","name":"name-65","amount":0.1419053771437182},
              {"id":"id-66","name":"name-66","amount":0.24820819883369183},
              {"id":"id-67","name":"name-67","amount":0.5499787981260453},
              {"id":"id-68","name":"name-68","amount":0.6284382429518218},
              {"id":"id-69","name":"name-69","amount":0.470888346297215},
              {"id":"id-70","name":"name-70","amount":0.8425145070379121},
              {"id":"id-71","name":"name-71","amount":0.3677326549910367},
              {"id":"id-72","name":"name-72","amount":0.24741024602700767},
              {"id":"id-73","name":"name-73","amount":0.9025306255737934},
              {"id":"id-74","name":"name-74","amount":0.12553399023265355},
              {"id":"id-75","name":"name-75","amount":0.285393854758192},
              {"id":"id-76","name":"name-76","amount":0.4853112304266747},
              {"id":"id-77","name":"name-77","amount":0.6899969023631835},
              {"id":"id-78","name":"name-78","amount":0.13911174124695813},
              {"id":"id-79","name":"name-79","amount":0.1386964823763005},
              {"id":"id-80","name":"name-80","amount":0.489119828949079},
              {"id":"id-81","name":"name-81","amount":0.8997534326953368},
              {"id":"id-82","name":"name-82","amount":0.661069370046017},
              {"id":"id-83","name":"name-83","amount":0.2872599095919345},
              {"id":"id-84","name":"name-84","amount":0.9411063497800555},
              {"id":"id-85","name":"name-85","amount":0.14066955924298785},
              {"id":"id-86","name":"name-86","amount":0.9480672400441139},
              {"id":"id-87","name":"name-87","amount":0.5299968403244257},
              {"id":"id-88","name":"name-88","amount":0.30845503854178247},
              {"id":"id-89","name":"name-89","amount":0.9951465150137809},
              {"id":"id-90","name":"name-90","amount":0.3812768848252813},
              {"id":"id-91","name":"name-91","amount":0.009428908298641292},
              {"id":"id-92","name":"name-92","amount":0.5322109436576005},
              {"id":"id-93","name":"name-93","amount":0.24971611052532616},
              {"id":"id-94","name":"name-94","amount":0.6994641510112819},
              {"id":"id-95","name":"name-95","amount":0.5661225430977684},
              {"id":"id-96","name":"name-96","amount":0.2859525234078464},
              {"id":"id-97","name":"name-97","amount":0.44540354806625837},
              {"id":"id-98","name":"name-98","amount":0.40349841366242856},
              {"id":"id-99","name":"name-99","amount":0.9429332179372871}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.9655732972527412},
              {"id":"id-1","name":"name-1","amount":0.87065599925237},
              {"id":"id-2","name":"name-2","amount":0.7864151862478206},
              {"id":"id-3","name":"name-3","amount":0.2704905513005842},
              {"id":"id-4","name":"name-4","amount":0.31840840510330704},
              {"id":"id-5","name":"name-5","amount":0.4471461476110826},
              {"id":"id-6","name":"name-6","amount":0.3788710548678398},
              {"id":"id-7","name":"name-7","amount":0.401403795262372},
              {"id":"id-8","name":"name-8","amount":0.2525924708064111},
              {"id":"id-9","name":"name-9","amount":0.46187089860554864},
              {"id":"id-10","name":"name-10","amount":0.6010658996928915},
              {"id":"id-11","name":"name-11","amount":0.31789920675781547},
              {"id":"id-12","name":"name-12","amount":0.6004118123187718},
              {"id":"id-13","name":"name-13","amount":0.8564879699300012},
              {"id":"id-14","name":"name-14","amount":0.7947033507058839},
              {"id":"id-15","name":"name-15","amount":0.38996150652370276},
              {"id":"id-16","name":"name-16","amount":0.9558225388806775},
              {"id":"id-17","name":"name-17","amount":0.6315985019989997},
              {"id":"id-18","name":"name-18","amount":0.3291444625304425},
              {"id":"id-19","name":"name-19","amount":0.747037269858827},
              {"id":"id-20","name":"name-20","amount":0.4156829297290926},
              {"id":"id-21","name":"name-21","amount":0.4186596569038906},
              {"id":"id-22","name":"name-22","amount":0.4358715628117783},
              {"id":"id-23","name":"name-23","amount":0.3123693180296464},
              {"id":"id-24","name":"name-24","amount":0.7685653309244056},
              {"id":"id-25","name":"name-25","amount":0.8509551239378043},
              {"id":"id-26","name":"name-26","amount":0.5324173787867023},
              {"id":"id-27","name":"name-27","amount":0.26091623550836074},
              {"id":"id-28","name":"name-28","amount":0.537427746355957},
              {"id":"id-29","name":"name-29","amount":0.47120298271407135},
              {"id":"id-30","name":"name-30","amount":0.6847147765141203},
              {"id":"id-31","name":"name-31","amount":0.36939287579232916},
              {"id":"id-32","name":"name-32","amount":0.5255901513257881},
              {"id":"id-33","name":"name-33","amount":0.945606609766574},
              {"id":"id-34","name":"name-34","amount":0.7406131463767036},
              {"id":"id-35","name":"name-35","amount":0.024820517340810477},
              {"id":"id-36","name":"name-36","amount":0.2898736795126734},
              {"id":"id-37","name":"name-37","amount":0.16763159479376366},
              {"id":"id-38","name":"name-38","amount":0.5823456106576517},
              {"id":"id-39","name":"name-39","amount":0.2370754426207855},
              {"id":"id-40","name":"name-40","amount":0.27042592207741123},
              {"id":"id-41","name":"name-41","amount":0.4295169930598096},
              {"id":"id-42","name":"name-42","amount":0.892020569336182},
              {"id":"id-43","name":"name-43","amount":0.8612775315984542},
              {"id":"id-44","name":"name-44","amount":0.1436685333662282},
              {"id":"id-45","name":"name-45","amount":0.215507225750748},
              {"id":"id-46","name":"name-46","amount":0.8017500294061837},
              {"id":"id-47","name":"name-47","amount":0.37746126257880097},
              {"id":"id-48","name":"name-48","amount":0.3329684824387448},
              {"id":"id-49","name":"name-49","amount":0.32801621568488126},
              {"id":"id-50","name":"name-50","amount":0.8088164707658966},
              {"id":"id-51","name":"name-51","amount":0.9978232783146281},
              {"id":"id-52","name":"name-52","amount":0.5110474958686005},
              {"id":"id-53","name":"name-53","amount":0.9964128588805371},
              {"id":"id-54","name":"name-54","amount":0.3763190025991201},
              {"id":"id-55","name":"name-55","amount":0.5759424352031844},
              {"id":"id-56","name":"name-56","amount":0.35880879809517463},
              {"id":"id-57","name":"name-57","amount":0.33784288329454015},
              {"id":"id-58","name":"name-58","amount":0.7110282134668189},
              {"id":"id-59","name":"name-59","amount":0.7777195164246552},
              {"id":"id-60","name":"name-60","amount":0.8071742934975499},
              {"id":"id-61","name":"name-61","amount":0.04047912736342307},
              {"id":"id-62","name":"name-62","amount":0.31271887636588824},
              {"id":"id-63","name":"name-63","amount":0.2403854948254761},
              {"id":"id-64","name":"name-64","amount":0.48168881951463016},
              {"id":"id-65","name":"name-65","amount":0.42181842016135473},
              {"id":"id-66","name":"name-66","amount":0.02303810789998284},
              {"id":"id-67","name":"name-67","amount":0.9937788864723743},
              {"id":"id-68","name":"name-68","amount":0.094063208117671},
              {"id":"id-69","name":"name-69","amount":0.07812024586520805},
              {"id":"id-70","name":"name-70","amount":0.46700615713730276},
              {"id":"id-71","name":"name-71","amount":0.24719408778048424},
              {"id":"id-72","name":"name-72","amount":0.08049094316660599},
              {"id":"id-73","name":"name-73","amount":0.18580866316620825},
              {"id":"id-74","name":"name-74","amount":0.9765353901209228},
              {"id":"id-75","name":"name-75","amount":0.7554542190961128},
              {"id":"id-76","name":"name-76","amount":0.8734876954223213},
              {"id":"id-77","name":"name-77","amount":0.14163549386466157},
              {"id":"id-78","name":"name-78","amount":0.3128932056797209},
              {"id":"id-79","name":"name-79","amount":0.36946389069059116},
              {"id":"id-80","name":"name-80","amount":0.8121674204238556},
              {"id":"id-81","name":"name-81","amount":0.6356295643270532},
              {"id":"id-82","name":"name-82","amount":0.7638221564184963},
              {"id":"id-83","name":"name-83","amount":0.0493481221916261},
              {"id":"id-84","name":"name-84","amount":0.845281973991088},
              {"id":"id-85","name":"name-85","amount":0.43933297411060834},
              {"id":"id-86","name":"name-86","amount":0.4810711775903681},
              {"id":"id-87","name":"name-87","amount":0.5723861253563197},
              {"id":"id-88","name":"name-88","amount":0.8620160179888446},
              {"id":"id-89","name":"name-89","amount":0.16155270640393404},
              {"id":"id-90","name":"name-90","amount":0.2453796898166607},
              {"id":"id-91","name":"name-91","amount":0.4032994202119782},
              {"id":"id-92","name":"name-92","amount":0.6974423600541039},
              {"id":"id-93","name":"name-93","amount":0.9748312110462718},
              {"id":"id-94","name":"name-94","amount":0.19849614808614469},
              {"id":"id-95","name":"name-95","amount":0.7110558357938424},
              {"id":"id-96","name":"name-96","amount":0.6027079989937615},
              {"id":"id-97","name":"name-97","amount":0.8480674425275042},
              {"id":"id-98","name":"name-98","amount":0.4656012149917115},
              {"id":"id-99","name":"name-99","amount":0.31420235223736726}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

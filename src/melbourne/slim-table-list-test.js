      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.929219744654479},
              {"id":"id-1","name":"name-1","amount":0.8623654219067994},
              {"id":"id-2","name":"name-2","amount":0.5038341543237661},
              {"id":"id-3","name":"name-3","amount":0.4706971900966389},
              {"id":"id-4","name":"name-4","amount":0.23515321094070607},
              {"id":"id-5","name":"name-5","amount":0.7966935348654026},
              {"id":"id-6","name":"name-6","amount":0.38149784263858033},
              {"id":"id-7","name":"name-7","amount":0.9540433439183926},
              {"id":"id-8","name":"name-8","amount":0.6121442877706517},
              {"id":"id-9","name":"name-9","amount":0.08964529527298137},
              {"id":"id-10","name":"name-10","amount":0.4523321858431182},
              {"id":"id-11","name":"name-11","amount":0.3828691149617095},
              {"id":"id-12","name":"name-12","amount":0.8518329996390327},
              {"id":"id-13","name":"name-13","amount":0.6768313458347199},
              {"id":"id-14","name":"name-14","amount":0.16534983830800087},
              {"id":"id-15","name":"name-15","amount":0.48440307054775544},
              {"id":"id-16","name":"name-16","amount":0.3881693017682679},
              {"id":"id-17","name":"name-17","amount":0.583962049990324},
              {"id":"id-18","name":"name-18","amount":0.15360536931936097},
              {"id":"id-19","name":"name-19","amount":0.6354195610233248},
              {"id":"id-20","name":"name-20","amount":0.356781823597465},
              {"id":"id-21","name":"name-21","amount":0.33177355292803146},
              {"id":"id-22","name":"name-22","amount":0.049728956608024566},
              {"id":"id-23","name":"name-23","amount":0.44696346600957493},
              {"id":"id-24","name":"name-24","amount":0.5737886061720705},
              {"id":"id-25","name":"name-25","amount":0.654355124055246},
              {"id":"id-26","name":"name-26","amount":0.5157173733764303},
              {"id":"id-27","name":"name-27","amount":0.34462025306805255},
              {"id":"id-28","name":"name-28","amount":0.6430650475718882},
              {"id":"id-29","name":"name-29","amount":0.555566372926773},
              {"id":"id-30","name":"name-30","amount":0.2824226930555983},
              {"id":"id-31","name":"name-31","amount":0.9937271753325265},
              {"id":"id-32","name":"name-32","amount":0.8316477435607462},
              {"id":"id-33","name":"name-33","amount":0.4479597308080786},
              {"id":"id-34","name":"name-34","amount":0.06546882840410762},
              {"id":"id-35","name":"name-35","amount":0.40427295101102423},
              {"id":"id-36","name":"name-36","amount":0.31486752967908516},
              {"id":"id-37","name":"name-37","amount":0.6196000200266921},
              {"id":"id-38","name":"name-38","amount":0.3268644384944325},
              {"id":"id-39","name":"name-39","amount":0.8168347937972238},
              {"id":"id-40","name":"name-40","amount":0.8859685161535076},
              {"id":"id-41","name":"name-41","amount":0.5563994996793434},
              {"id":"id-42","name":"name-42","amount":0.9853702032002434},
              {"id":"id-43","name":"name-43","amount":0.018753214045174937},
              {"id":"id-44","name":"name-44","amount":0.24938435932858438},
              {"id":"id-45","name":"name-45","amount":0.711063374807517},
              {"id":"id-46","name":"name-46","amount":0.343717162059769},
              {"id":"id-47","name":"name-47","amount":0.5688464519457237},
              {"id":"id-48","name":"name-48","amount":0.5725071960395841},
              {"id":"id-49","name":"name-49","amount":0.15446716331241128},
              {"id":"id-50","name":"name-50","amount":0.6970625905889878},
              {"id":"id-51","name":"name-51","amount":0.5193184660539281},
              {"id":"id-52","name":"name-52","amount":0.05769810360312255},
              {"id":"id-53","name":"name-53","amount":0.17126438001799527},
              {"id":"id-54","name":"name-54","amount":0.31460777692323316},
              {"id":"id-55","name":"name-55","amount":0.6151152952148039},
              {"id":"id-56","name":"name-56","amount":0.9144527687720623},
              {"id":"id-57","name":"name-57","amount":0.26874869385003497},
              {"id":"id-58","name":"name-58","amount":0.7450924758204373},
              {"id":"id-59","name":"name-59","amount":0.6238364402836853},
              {"id":"id-60","name":"name-60","amount":0.2610494526630308},
              {"id":"id-61","name":"name-61","amount":0.25647229053275944},
              {"id":"id-62","name":"name-62","amount":0.6869187934770474},
              {"id":"id-63","name":"name-63","amount":0.4034098693745948},
              {"id":"id-64","name":"name-64","amount":0.1656711714414556},
              {"id":"id-65","name":"name-65","amount":0.023847799914823775},
              {"id":"id-66","name":"name-66","amount":0.9849467738986557},
              {"id":"id-67","name":"name-67","amount":0.5500901595035803},
              {"id":"id-68","name":"name-68","amount":0.24890692167876471},
              {"id":"id-69","name":"name-69","amount":0.39393834069644484},
              {"id":"id-70","name":"name-70","amount":0.6685433169992119},
              {"id":"id-71","name":"name-71","amount":0.9859411153772524},
              {"id":"id-72","name":"name-72","amount":0.012702235127731165},
              {"id":"id-73","name":"name-73","amount":0.9638666415565706},
              {"id":"id-74","name":"name-74","amount":0.3292542915998662},
              {"id":"id-75","name":"name-75","amount":0.6428161182447252},
              {"id":"id-76","name":"name-76","amount":0.33524223909656525},
              {"id":"id-77","name":"name-77","amount":0.15575057643190549},
              {"id":"id-78","name":"name-78","amount":0.5515096591828007},
              {"id":"id-79","name":"name-79","amount":0.47895036639906496},
              {"id":"id-80","name":"name-80","amount":0.37691507677933567},
              {"id":"id-81","name":"name-81","amount":0.7967991904087606},
              {"id":"id-82","name":"name-82","amount":0.5560599971853187},
              {"id":"id-83","name":"name-83","amount":0.42463132415750815},
              {"id":"id-84","name":"name-84","amount":0.4794175481280476},
              {"id":"id-85","name":"name-85","amount":0.42317979530756356},
              {"id":"id-86","name":"name-86","amount":0.6933817770331736},
              {"id":"id-87","name":"name-87","amount":0.4950147435846759},
              {"id":"id-88","name":"name-88","amount":0.5082285833627244},
              {"id":"id-89","name":"name-89","amount":0.15949341270213524},
              {"id":"id-90","name":"name-90","amount":0.9330783504281794},
              {"id":"id-91","name":"name-91","amount":0.23100585762859116},
              {"id":"id-92","name":"name-92","amount":0.4880906563879338},
              {"id":"id-93","name":"name-93","amount":0.4641720811704183},
              {"id":"id-94","name":"name-94","amount":0.03534195007728247},
              {"id":"id-95","name":"name-95","amount":0.8332259781983651},
              {"id":"id-96","name":"name-96","amount":0.3118030090024161},
              {"id":"id-97","name":"name-97","amount":0.25083857571777535},
              {"id":"id-98","name":"name-98","amount":0.661831800287463},
              {"id":"id-99","name":"name-99","amount":0.8394372101931938}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.8346467520978473},
              {"id":"id-1","name":"name-1","amount":0.8748734831452959},
              {"id":"id-2","name":"name-2","amount":0.21135913863438793},
              {"id":"id-3","name":"name-3","amount":0.6499458253012954},
              {"id":"id-4","name":"name-4","amount":0.968720226104322},
              {"id":"id-5","name":"name-5","amount":0.536733534775109},
              {"id":"id-6","name":"name-6","amount":0.576705667223561},
              {"id":"id-7","name":"name-7","amount":0.5321649237567455},
              {"id":"id-8","name":"name-8","amount":0.5593670745036932},
              {"id":"id-9","name":"name-9","amount":0.7472103215901192},
              {"id":"id-10","name":"name-10","amount":0.24255026287639914},
              {"id":"id-11","name":"name-11","amount":0.6370005820859802},
              {"id":"id-12","name":"name-12","amount":0.8770678482392389},
              {"id":"id-13","name":"name-13","amount":0.28466814434265775},
              {"id":"id-14","name":"name-14","amount":0.15128474359836153},
              {"id":"id-15","name":"name-15","amount":0.44009705403186816},
              {"id":"id-16","name":"name-16","amount":0.2549224831801392},
              {"id":"id-17","name":"name-17","amount":0.02494990714251155},
              {"id":"id-18","name":"name-18","amount":0.789390284683587},
              {"id":"id-19","name":"name-19","amount":0.6007282716787207},
              {"id":"id-20","name":"name-20","amount":0.8814940655282736},
              {"id":"id-21","name":"name-21","amount":0.30741552630378666},
              {"id":"id-22","name":"name-22","amount":0.6174638466985892},
              {"id":"id-23","name":"name-23","amount":0.4197652083097021},
              {"id":"id-24","name":"name-24","amount":0.22151066192290814},
              {"id":"id-25","name":"name-25","amount":0.5429820243709453},
              {"id":"id-26","name":"name-26","amount":0.4343313970707857},
              {"id":"id-27","name":"name-27","amount":0.6389644106103425},
              {"id":"id-28","name":"name-28","amount":0.05700964468536496},
              {"id":"id-29","name":"name-29","amount":0.3011339989444457},
              {"id":"id-30","name":"name-30","amount":0.19761734055966862},
              {"id":"id-31","name":"name-31","amount":0.6959877274108143},
              {"id":"id-32","name":"name-32","amount":0.05264140963964614},
              {"id":"id-33","name":"name-33","amount":0.28181897379987264},
              {"id":"id-34","name":"name-34","amount":0.06239736521538941},
              {"id":"id-35","name":"name-35","amount":0.17163421996431538},
              {"id":"id-36","name":"name-36","amount":0.5662323394175462},
              {"id":"id-37","name":"name-37","amount":0.9033373024824818},
              {"id":"id-38","name":"name-38","amount":0.04506960163931428},
              {"id":"id-39","name":"name-39","amount":0.4440852806078305},
              {"id":"id-40","name":"name-40","amount":0.14933977266624887},
              {"id":"id-41","name":"name-41","amount":0.7187812788988392},
              {"id":"id-42","name":"name-42","amount":0.7713370016862329},
              {"id":"id-43","name":"name-43","amount":0.4995341109225181},
              {"id":"id-44","name":"name-44","amount":0.812414405407642},
              {"id":"id-45","name":"name-45","amount":0.5112740330058158},
              {"id":"id-46","name":"name-46","amount":0.22520169135120105},
              {"id":"id-47","name":"name-47","amount":0.43939131953534716},
              {"id":"id-48","name":"name-48","amount":0.665318317678339},
              {"id":"id-49","name":"name-49","amount":0.712203506747373},
              {"id":"id-50","name":"name-50","amount":0.2801294881457431},
              {"id":"id-51","name":"name-51","amount":0.47132873352216476},
              {"id":"id-52","name":"name-52","amount":0.9863299994320177},
              {"id":"id-53","name":"name-53","amount":0.7368425957890308},
              {"id":"id-54","name":"name-54","amount":0.06405095807888417},
              {"id":"id-55","name":"name-55","amount":0.07474333756652929},
              {"id":"id-56","name":"name-56","amount":0.12139991399973227},
              {"id":"id-57","name":"name-57","amount":0.9381913797906939},
              {"id":"id-58","name":"name-58","amount":0.8866232336334844},
              {"id":"id-59","name":"name-59","amount":0.5907944391447141},
              {"id":"id-60","name":"name-60","amount":0.8703037289697375},
              {"id":"id-61","name":"name-61","amount":0.14257324469625687},
              {"id":"id-62","name":"name-62","amount":0.5401842473617761},
              {"id":"id-63","name":"name-63","amount":0.7029864426909561},
              {"id":"id-64","name":"name-64","amount":0.177472338230374},
              {"id":"id-65","name":"name-65","amount":0.14946138962890698},
              {"id":"id-66","name":"name-66","amount":0.27508914370064497},
              {"id":"id-67","name":"name-67","amount":0.14634077094209808},
              {"id":"id-68","name":"name-68","amount":0.01266147337315826},
              {"id":"id-69","name":"name-69","amount":0.15320813735359284},
              {"id":"id-70","name":"name-70","amount":0.6456264904550475},
              {"id":"id-71","name":"name-71","amount":0.5115203980256957},
              {"id":"id-72","name":"name-72","amount":0.3002557049171315},
              {"id":"id-73","name":"name-73","amount":0.7757941871122694},
              {"id":"id-74","name":"name-74","amount":0.724469595622821},
              {"id":"id-75","name":"name-75","amount":0.1948407656658656},
              {"id":"id-76","name":"name-76","amount":0.6358849441219918},
              {"id":"id-77","name":"name-77","amount":0.2874108163367568},
              {"id":"id-78","name":"name-78","amount":0.8916257299348703},
              {"id":"id-79","name":"name-79","amount":0.38592127291572187},
              {"id":"id-80","name":"name-80","amount":0.31516434166372975},
              {"id":"id-81","name":"name-81","amount":0.6356329075311304},
              {"id":"id-82","name":"name-82","amount":0.5181047613704435},
              {"id":"id-83","name":"name-83","amount":0.48180185246793095},
              {"id":"id-84","name":"name-84","amount":0.8917509487686711},
              {"id":"id-85","name":"name-85","amount":0.10413627702520423},
              {"id":"id-86","name":"name-86","amount":0.3850355851410655},
              {"id":"id-87","name":"name-87","amount":0.4696691940317814},
              {"id":"id-88","name":"name-88","amount":0.0805438963363787},
              {"id":"id-89","name":"name-89","amount":0.7783579212399738},
              {"id":"id-90","name":"name-90","amount":0.6057169104625325},
              {"id":"id-91","name":"name-91","amount":0.6299081544902653},
              {"id":"id-92","name":"name-92","amount":0.3267369080534379},
              {"id":"id-93","name":"name-93","amount":0.5081930994236314},
              {"id":"id-94","name":"name-94","amount":0.15109702824186177},
              {"id":"id-95","name":"name-95","amount":0.3770131382561466},
              {"id":"id-96","name":"name-96","amount":0.7725654959270539},
              {"id":"id-97","name":"name-97","amount":0.7267689375361605},
              {"id":"id-98","name":"name-98","amount":0.818434490845317},
              {"id":"id-99","name":"name-99","amount":0.17796573294306128}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

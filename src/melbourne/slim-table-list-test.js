      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.6546315833876887},
              {"id":"id-1","name":"name-1","amount":0.3638763480197936},
              {"id":"id-2","name":"name-2","amount":0.21013973424523436},
              {"id":"id-3","name":"name-3","amount":0.1806906041620443},
              {"id":"id-4","name":"name-4","amount":0.959825999096976},
              {"id":"id-5","name":"name-5","amount":0.9848693776617427},
              {"id":"id-6","name":"name-6","amount":0.7069545187556489},
              {"id":"id-7","name":"name-7","amount":0.08343234732472238},
              {"id":"id-8","name":"name-8","amount":0.28842350485137636},
              {"id":"id-9","name":"name-9","amount":0.532903833907121},
              {"id":"id-10","name":"name-10","amount":0.44416025341268817},
              {"id":"id-11","name":"name-11","amount":0.567132698625787},
              {"id":"id-12","name":"name-12","amount":0.4315883847378442},
              {"id":"id-13","name":"name-13","amount":0.9864364180168754},
              {"id":"id-14","name":"name-14","amount":0.6629175244493003},
              {"id":"id-15","name":"name-15","amount":0.21249537155675424},
              {"id":"id-16","name":"name-16","amount":0.16067928268796572},
              {"id":"id-17","name":"name-17","amount":0.313280887357997},
              {"id":"id-18","name":"name-18","amount":0.24671874962806184},
              {"id":"id-19","name":"name-19","amount":0.03014834663763677},
              {"id":"id-20","name":"name-20","amount":0.5949111494696312},
              {"id":"id-21","name":"name-21","amount":0.47729211745973277},
              {"id":"id-22","name":"name-22","amount":0.22200075870799185},
              {"id":"id-23","name":"name-23","amount":0.7798933390067091},
              {"id":"id-24","name":"name-24","amount":0.6885631209770421},
              {"id":"id-25","name":"name-25","amount":0.034971170626077464},
              {"id":"id-26","name":"name-26","amount":0.39821545319992346},
              {"id":"id-27","name":"name-27","amount":0.9472743102509249},
              {"id":"id-28","name":"name-28","amount":0.4735051609890444},
              {"id":"id-29","name":"name-29","amount":0.656250487845216},
              {"id":"id-30","name":"name-30","amount":0.9476831237274672},
              {"id":"id-31","name":"name-31","amount":0.23955598297988923},
              {"id":"id-32","name":"name-32","amount":0.5297299874185634},
              {"id":"id-33","name":"name-33","amount":0.2796945625851299},
              {"id":"id-34","name":"name-34","amount":0.7030900400239244},
              {"id":"id-35","name":"name-35","amount":0.6048053252061477},
              {"id":"id-36","name":"name-36","amount":0.5247412603920868},
              {"id":"id-37","name":"name-37","amount":0.7695785039041452},
              {"id":"id-38","name":"name-38","amount":0.959282666850415},
              {"id":"id-39","name":"name-39","amount":0.20061987234620904},
              {"id":"id-40","name":"name-40","amount":0.5620629766790207},
              {"id":"id-41","name":"name-41","amount":0.8807831130080328},
              {"id":"id-42","name":"name-42","amount":0.606048697702547},
              {"id":"id-43","name":"name-43","amount":0.44314870826854214},
              {"id":"id-44","name":"name-44","amount":0.509798845664177},
              {"id":"id-45","name":"name-45","amount":0.05717164424196797},
              {"id":"id-46","name":"name-46","amount":0.48986476075028473},
              {"id":"id-47","name":"name-47","amount":0.25240357728111873},
              {"id":"id-48","name":"name-48","amount":0.4420848622807173},
              {"id":"id-49","name":"name-49","amount":0.09009034321967901},
              {"id":"id-50","name":"name-50","amount":0.005129768743632801},
              {"id":"id-51","name":"name-51","amount":0.8764587972602881},
              {"id":"id-52","name":"name-52","amount":0.8194420009910593},
              {"id":"id-53","name":"name-53","amount":0.9458608251601354},
              {"id":"id-54","name":"name-54","amount":0.04919153112115382},
              {"id":"id-55","name":"name-55","amount":0.22499053766428956},
              {"id":"id-56","name":"name-56","amount":0.05845027312405693},
              {"id":"id-57","name":"name-57","amount":0.134609789512245},
              {"id":"id-58","name":"name-58","amount":0.6405137484825195},
              {"id":"id-59","name":"name-59","amount":0.4717074526579601},
              {"id":"id-60","name":"name-60","amount":0.6968293043692353},
              {"id":"id-61","name":"name-61","amount":0.8375069310250531},
              {"id":"id-62","name":"name-62","amount":0.6956192427036965},
              {"id":"id-63","name":"name-63","amount":0.7955761405408085},
              {"id":"id-64","name":"name-64","amount":0.44692469603944684},
              {"id":"id-65","name":"name-65","amount":0.6354596431108904},
              {"id":"id-66","name":"name-66","amount":0.6879844770803571},
              {"id":"id-67","name":"name-67","amount":0.522346763944168},
              {"id":"id-68","name":"name-68","amount":0.04876353912690723},
              {"id":"id-69","name":"name-69","amount":0.08953911883248677},
              {"id":"id-70","name":"name-70","amount":0.1708496429468609},
              {"id":"id-71","name":"name-71","amount":0.6007352187516937},
              {"id":"id-72","name":"name-72","amount":0.9832564647872233},
              {"id":"id-73","name":"name-73","amount":0.6118888689882884},
              {"id":"id-74","name":"name-74","amount":0.4359472063858846},
              {"id":"id-75","name":"name-75","amount":0.3017204056508439},
              {"id":"id-76","name":"name-76","amount":0.7867876131975204},
              {"id":"id-77","name":"name-77","amount":0.03559343596845643},
              {"id":"id-78","name":"name-78","amount":0.9014414749464037},
              {"id":"id-79","name":"name-79","amount":0.2647662014669958},
              {"id":"id-80","name":"name-80","amount":0.9203481678702026},
              {"id":"id-81","name":"name-81","amount":0.04296203729566317},
              {"id":"id-82","name":"name-82","amount":0.17491016494639755},
              {"id":"id-83","name":"name-83","amount":0.5313796745244092},
              {"id":"id-84","name":"name-84","amount":0.8895329341086347},
              {"id":"id-85","name":"name-85","amount":0.14390747432908235},
              {"id":"id-86","name":"name-86","amount":0.12098859854414368},
              {"id":"id-87","name":"name-87","amount":0.0042682404870066915},
              {"id":"id-88","name":"name-88","amount":0.5861335834232017},
              {"id":"id-89","name":"name-89","amount":0.20957831676395822},
              {"id":"id-90","name":"name-90","amount":0.6783357564406074},
              {"id":"id-91","name":"name-91","amount":0.8494606005962123},
              {"id":"id-92","name":"name-92","amount":0.6277264615718268},
              {"id":"id-93","name":"name-93","amount":0.6611278754719006},
              {"id":"id-94","name":"name-94","amount":0.6168708343715362},
              {"id":"id-95","name":"name-95","amount":0.7191072822745181},
              {"id":"id-96","name":"name-96","amount":0.8085664021807787},
              {"id":"id-97","name":"name-97","amount":0.2894812007411416},
              {"id":"id-98","name":"name-98","amount":0.9037676199383491},
              {"id":"id-99","name":"name-99","amount":0.3142783647541494}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

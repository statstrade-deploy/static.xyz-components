      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.3511889163496351},
              {"id":"id-1","name":"name-1","amount":0.8250323687463742},
              {"id":"id-2","name":"name-2","amount":0.05331853892348448},
              {"id":"id-3","name":"name-3","amount":0.9347792746532944},
              {"id":"id-4","name":"name-4","amount":0.6121045566198846},
              {"id":"id-5","name":"name-5","amount":0.6202238358604393},
              {"id":"id-6","name":"name-6","amount":0.020200298765230107},
              {"id":"id-7","name":"name-7","amount":0.7705354296131248},
              {"id":"id-8","name":"name-8","amount":0.4044169750480402},
              {"id":"id-9","name":"name-9","amount":0.5237677250108468},
              {"id":"id-10","name":"name-10","amount":0.010539263072480098},
              {"id":"id-11","name":"name-11","amount":0.44705208450239964},
              {"id":"id-12","name":"name-12","amount":0.2992657181287588},
              {"id":"id-13","name":"name-13","amount":0.707732039936701},
              {"id":"id-14","name":"name-14","amount":0.49446615814149275},
              {"id":"id-15","name":"name-15","amount":0.013408819477695011},
              {"id":"id-16","name":"name-16","amount":0.3727369454718267},
              {"id":"id-17","name":"name-17","amount":0.45452300222101416},
              {"id":"id-18","name":"name-18","amount":0.905595815223612},
              {"id":"id-19","name":"name-19","amount":0.9751424033617793},
              {"id":"id-20","name":"name-20","amount":0.1651309633743534},
              {"id":"id-21","name":"name-21","amount":0.792661898673857},
              {"id":"id-22","name":"name-22","amount":0.6736671059515981},
              {"id":"id-23","name":"name-23","amount":0.4673737014395912},
              {"id":"id-24","name":"name-24","amount":0.7518260997165842},
              {"id":"id-25","name":"name-25","amount":0.5361881958832043},
              {"id":"id-26","name":"name-26","amount":0.9216507793793351},
              {"id":"id-27","name":"name-27","amount":0.2346525934203244},
              {"id":"id-28","name":"name-28","amount":0.717272909255072},
              {"id":"id-29","name":"name-29","amount":0.16692883067311337},
              {"id":"id-30","name":"name-30","amount":0.40059775347681736},
              {"id":"id-31","name":"name-31","amount":0.18927965602180796},
              {"id":"id-32","name":"name-32","amount":0.7699425155638276},
              {"id":"id-33","name":"name-33","amount":0.8592243471934617},
              {"id":"id-34","name":"name-34","amount":0.0724148597343105},
              {"id":"id-35","name":"name-35","amount":0.6958404260457811},
              {"id":"id-36","name":"name-36","amount":0.7135914525058342},
              {"id":"id-37","name":"name-37","amount":0.08830463443113867},
              {"id":"id-38","name":"name-38","amount":0.11891841106099721},
              {"id":"id-39","name":"name-39","amount":0.8869143039895168},
              {"id":"id-40","name":"name-40","amount":0.49899473546538753},
              {"id":"id-41","name":"name-41","amount":0.6863587233469396},
              {"id":"id-42","name":"name-42","amount":0.05493112143718337},
              {"id":"id-43","name":"name-43","amount":0.2533968815815695},
              {"id":"id-44","name":"name-44","amount":0.12033772953158717},
              {"id":"id-45","name":"name-45","amount":0.9144438941636683},
              {"id":"id-46","name":"name-46","amount":0.053850678470134916},
              {"id":"id-47","name":"name-47","amount":0.472600799968691},
              {"id":"id-48","name":"name-48","amount":0.1917467016739257},
              {"id":"id-49","name":"name-49","amount":0.10373178455882126},
              {"id":"id-50","name":"name-50","amount":0.5560334701868992},
              {"id":"id-51","name":"name-51","amount":0.9382772862042815},
              {"id":"id-52","name":"name-52","amount":0.14197658440172545},
              {"id":"id-53","name":"name-53","amount":0.6861903729232851},
              {"id":"id-54","name":"name-54","amount":0.723500378044424},
              {"id":"id-55","name":"name-55","amount":0.7389265307602372},
              {"id":"id-56","name":"name-56","amount":0.09906421268833832},
              {"id":"id-57","name":"name-57","amount":0.9826519338367444},
              {"id":"id-58","name":"name-58","amount":0.3288856428406749},
              {"id":"id-59","name":"name-59","amount":0.8942419057477357},
              {"id":"id-60","name":"name-60","amount":0.7017935312665076},
              {"id":"id-61","name":"name-61","amount":0.9453194132657381},
              {"id":"id-62","name":"name-62","amount":0.2222142760458835},
              {"id":"id-63","name":"name-63","amount":0.5042596691093783},
              {"id":"id-64","name":"name-64","amount":0.2711090903034564},
              {"id":"id-65","name":"name-65","amount":0.16211443670018644},
              {"id":"id-66","name":"name-66","amount":0.6060070594418429},
              {"id":"id-67","name":"name-67","amount":0.09176216482824062},
              {"id":"id-68","name":"name-68","amount":0.002152722722489786},
              {"id":"id-69","name":"name-69","amount":0.8218723992467744},
              {"id":"id-70","name":"name-70","amount":0.967376624097468},
              {"id":"id-71","name":"name-71","amount":0.8257092241363622},
              {"id":"id-72","name":"name-72","amount":0.09638742909267961},
              {"id":"id-73","name":"name-73","amount":0.012240871965234268},
              {"id":"id-74","name":"name-74","amount":0.665191831196425},
              {"id":"id-75","name":"name-75","amount":0.5019489315519104},
              {"id":"id-76","name":"name-76","amount":0.043311962542130766},
              {"id":"id-77","name":"name-77","amount":0.6762401419194549},
              {"id":"id-78","name":"name-78","amount":0.8510520480731634},
              {"id":"id-79","name":"name-79","amount":0.1271855595632092},
              {"id":"id-80","name":"name-80","amount":0.5825579462495963},
              {"id":"id-81","name":"name-81","amount":0.7887951506129088},
              {"id":"id-82","name":"name-82","amount":0.614726879925884},
              {"id":"id-83","name":"name-83","amount":0.7031590584904261},
              {"id":"id-84","name":"name-84","amount":0.2297011178323929},
              {"id":"id-85","name":"name-85","amount":0.8311506535180607},
              {"id":"id-86","name":"name-86","amount":0.9878806747739278},
              {"id":"id-87","name":"name-87","amount":0.3402169687885054},
              {"id":"id-88","name":"name-88","amount":0.6329069898817422},
              {"id":"id-89","name":"name-89","amount":0.43893233719959734},
              {"id":"id-90","name":"name-90","amount":0.7143158137021969},
              {"id":"id-91","name":"name-91","amount":0.14293624022647566},
              {"id":"id-92","name":"name-92","amount":0.44257022980781635},
              {"id":"id-93","name":"name-93","amount":0.17871822465262455},
              {"id":"id-94","name":"name-94","amount":0.5006321504088572},
              {"id":"id-95","name":"name-95","amount":0.40517898737231195},
              {"id":"id-96","name":"name-96","amount":0.8223963354412607},
              {"id":"id-97","name":"name-97","amount":0.7683369292259523},
              {"id":"id-98","name":"name-98","amount":0.7981145663467613},
              {"id":"id-99","name":"name-99","amount":0.5279427730360381}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

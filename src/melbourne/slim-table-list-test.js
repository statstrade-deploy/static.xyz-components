      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.7369147517515682},
              {"id":"id-1","name":"name-1","amount":0.05375950484883485},
              {"id":"id-2","name":"name-2","amount":0.2114463629671256},
              {"id":"id-3","name":"name-3","amount":0.7833319291803081},
              {"id":"id-4","name":"name-4","amount":0.5813255700944536},
              {"id":"id-5","name":"name-5","amount":0.36901483703805704},
              {"id":"id-6","name":"name-6","amount":0.9980553020423113},
              {"id":"id-7","name":"name-7","amount":0.23320913568071822},
              {"id":"id-8","name":"name-8","amount":0.9178031684699145},
              {"id":"id-9","name":"name-9","amount":0.6939544319377228},
              {"id":"id-10","name":"name-10","amount":0.3559726963499962},
              {"id":"id-11","name":"name-11","amount":0.9810630860599355},
              {"id":"id-12","name":"name-12","amount":0.20273811548629106},
              {"id":"id-13","name":"name-13","amount":0.5644374134655425},
              {"id":"id-14","name":"name-14","amount":0.10044179470460268},
              {"id":"id-15","name":"name-15","amount":0.1893379842161167},
              {"id":"id-16","name":"name-16","amount":0.4395728493648662},
              {"id":"id-17","name":"name-17","amount":0.7749106446253811},
              {"id":"id-18","name":"name-18","amount":0.5327052883179255},
              {"id":"id-19","name":"name-19","amount":0.9180987258384418},
              {"id":"id-20","name":"name-20","amount":0.23405955810450307},
              {"id":"id-21","name":"name-21","amount":0.8280179011616889},
              {"id":"id-22","name":"name-22","amount":0.33567966262202076},
              {"id":"id-23","name":"name-23","amount":0.28442958902814774},
              {"id":"id-24","name":"name-24","amount":0.279626091201746},
              {"id":"id-25","name":"name-25","amount":0.6222163161625213},
              {"id":"id-26","name":"name-26","amount":0.7597380356694761},
              {"id":"id-27","name":"name-27","amount":0.7614672752765483},
              {"id":"id-28","name":"name-28","amount":0.9677046360662744},
              {"id":"id-29","name":"name-29","amount":0.16527301803100658},
              {"id":"id-30","name":"name-30","amount":0.7783199013238767},
              {"id":"id-31","name":"name-31","amount":0.06558484192657532},
              {"id":"id-32","name":"name-32","amount":0.42041700210898425},
              {"id":"id-33","name":"name-33","amount":0.8681152406387426},
              {"id":"id-34","name":"name-34","amount":0.8862494794403699},
              {"id":"id-35","name":"name-35","amount":0.8624699838361328},
              {"id":"id-36","name":"name-36","amount":0.8767994862721032},
              {"id":"id-37","name":"name-37","amount":0.02135977092010688},
              {"id":"id-38","name":"name-38","amount":0.7380590287331621},
              {"id":"id-39","name":"name-39","amount":0.08631769815490664},
              {"id":"id-40","name":"name-40","amount":0.02878893887816769},
              {"id":"id-41","name":"name-41","amount":0.38594843705385706},
              {"id":"id-42","name":"name-42","amount":0.8792773850686748},
              {"id":"id-43","name":"name-43","amount":0.011083929746768528},
              {"id":"id-44","name":"name-44","amount":0.5994813578181423},
              {"id":"id-45","name":"name-45","amount":0.43966858875380943},
              {"id":"id-46","name":"name-46","amount":0.410557774358699},
              {"id":"id-47","name":"name-47","amount":0.3387230627154959},
              {"id":"id-48","name":"name-48","amount":0.18371284730196136},
              {"id":"id-49","name":"name-49","amount":0.712938050809999},
              {"id":"id-50","name":"name-50","amount":0.5426833899176151},
              {"id":"id-51","name":"name-51","amount":0.4765591090011503},
              {"id":"id-52","name":"name-52","amount":0.12980214101755416},
              {"id":"id-53","name":"name-53","amount":0.8200870440129743},
              {"id":"id-54","name":"name-54","amount":0.6499030971963591},
              {"id":"id-55","name":"name-55","amount":0.8644168368059413},
              {"id":"id-56","name":"name-56","amount":0.031332827087118376},
              {"id":"id-57","name":"name-57","amount":0.246469625032948},
              {"id":"id-58","name":"name-58","amount":0.6097137090737061},
              {"id":"id-59","name":"name-59","amount":0.6818654161235457},
              {"id":"id-60","name":"name-60","amount":0.21914247501499662},
              {"id":"id-61","name":"name-61","amount":0.6870899611536464},
              {"id":"id-62","name":"name-62","amount":0.9291193239540223},
              {"id":"id-63","name":"name-63","amount":0.5169041362392349},
              {"id":"id-64","name":"name-64","amount":0.49622505288998875},
              {"id":"id-65","name":"name-65","amount":0.749029384100507},
              {"id":"id-66","name":"name-66","amount":0.40056240070268745},
              {"id":"id-67","name":"name-67","amount":0.6096460594375973},
              {"id":"id-68","name":"name-68","amount":0.2420419788084256},
              {"id":"id-69","name":"name-69","amount":0.12781266796670976},
              {"id":"id-70","name":"name-70","amount":0.8051349778006187},
              {"id":"id-71","name":"name-71","amount":0.09803192096283297},
              {"id":"id-72","name":"name-72","amount":0.9277761718460644},
              {"id":"id-73","name":"name-73","amount":0.9469524155218458},
              {"id":"id-74","name":"name-74","amount":0.48634320423269506},
              {"id":"id-75","name":"name-75","amount":0.2873335698549033},
              {"id":"id-76","name":"name-76","amount":0.030352554926847408},
              {"id":"id-77","name":"name-77","amount":0.8102632704340273},
              {"id":"id-78","name":"name-78","amount":0.45461129041959836},
              {"id":"id-79","name":"name-79","amount":0.34118238282523183},
              {"id":"id-80","name":"name-80","amount":0.31058779342871135},
              {"id":"id-81","name":"name-81","amount":0.2581380721706884},
              {"id":"id-82","name":"name-82","amount":0.0508764153942437},
              {"id":"id-83","name":"name-83","amount":0.9490847000415422},
              {"id":"id-84","name":"name-84","amount":0.4296205117438835},
              {"id":"id-85","name":"name-85","amount":0.7418303867052967},
              {"id":"id-86","name":"name-86","amount":0.09703891541310883},
              {"id":"id-87","name":"name-87","amount":0.46386338285928175},
              {"id":"id-88","name":"name-88","amount":0.9178130057441118},
              {"id":"id-89","name":"name-89","amount":0.9338891292167665},
              {"id":"id-90","name":"name-90","amount":0.8916969678486544},
              {"id":"id-91","name":"name-91","amount":0.7221902910275815},
              {"id":"id-92","name":"name-92","amount":0.5816040140915235},
              {"id":"id-93","name":"name-93","amount":0.17824254112656435},
              {"id":"id-94","name":"name-94","amount":0.37150888799129156},
              {"id":"id-95","name":"name-95","amount":0.2623519797570205},
              {"id":"id-96","name":"name-96","amount":0.536331273327245},
              {"id":"id-97","name":"name-97","amount":0.15003051856951677},
              {"id":"id-98","name":"name-98","amount":0.25168982035604626},
              {"id":"id-99","name":"name-99","amount":0.9356166489858974}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

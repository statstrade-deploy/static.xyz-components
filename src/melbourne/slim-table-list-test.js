      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.44844411416846874},
              {"id":"id-1","name":"name-1","amount":0.7206140295390978},
              {"id":"id-2","name":"name-2","amount":0.05668435623889467},
              {"id":"id-3","name":"name-3","amount":0.7605073592047752},
              {"id":"id-4","name":"name-4","amount":0.5204952224376647},
              {"id":"id-5","name":"name-5","amount":0.7966991087025377},
              {"id":"id-6","name":"name-6","amount":0.08638750527105554},
              {"id":"id-7","name":"name-7","amount":0.19909553156582094},
              {"id":"id-8","name":"name-8","amount":0.37262704289149684},
              {"id":"id-9","name":"name-9","amount":0.3909274054418319},
              {"id":"id-10","name":"name-10","amount":0.030485469395019282},
              {"id":"id-11","name":"name-11","amount":0.8299133606206729},
              {"id":"id-12","name":"name-12","amount":0.08861598260504888},
              {"id":"id-13","name":"name-13","amount":0.9865470645377307},
              {"id":"id-14","name":"name-14","amount":0.8526752993389851},
              {"id":"id-15","name":"name-15","amount":0.0222290039275701},
              {"id":"id-16","name":"name-16","amount":0.6087969362002157},
              {"id":"id-17","name":"name-17","amount":0.19960198463893708},
              {"id":"id-18","name":"name-18","amount":0.8686142598987993},
              {"id":"id-19","name":"name-19","amount":0.4923745454189752},
              {"id":"id-20","name":"name-20","amount":0.9688690571001775},
              {"id":"id-21","name":"name-21","amount":0.6335730729420825},
              {"id":"id-22","name":"name-22","amount":0.3019772571657161},
              {"id":"id-23","name":"name-23","amount":0.6341203947442983},
              {"id":"id-24","name":"name-24","amount":0.6851447661150276},
              {"id":"id-25","name":"name-25","amount":0.0055922473053692245},
              {"id":"id-26","name":"name-26","amount":0.5827368688654309},
              {"id":"id-27","name":"name-27","amount":0.8727743206316393},
              {"id":"id-28","name":"name-28","amount":0.3657404154019427},
              {"id":"id-29","name":"name-29","amount":0.407175313083038},
              {"id":"id-30","name":"name-30","amount":0.13757486241408756},
              {"id":"id-31","name":"name-31","amount":0.549016770316166},
              {"id":"id-32","name":"name-32","amount":0.06958984906804022},
              {"id":"id-33","name":"name-33","amount":0.5126142316581164},
              {"id":"id-34","name":"name-34","amount":0.6928409886078529},
              {"id":"id-35","name":"name-35","amount":0.7418052436779288},
              {"id":"id-36","name":"name-36","amount":0.28379447461436913},
              {"id":"id-37","name":"name-37","amount":0.6546151630218185},
              {"id":"id-38","name":"name-38","amount":0.7872334450968613},
              {"id":"id-39","name":"name-39","amount":0.999249931412114},
              {"id":"id-40","name":"name-40","amount":0.6447068274679437},
              {"id":"id-41","name":"name-41","amount":0.949463442799776},
              {"id":"id-42","name":"name-42","amount":0.2743827625219667},
              {"id":"id-43","name":"name-43","amount":0.16218351194757186},
              {"id":"id-44","name":"name-44","amount":0.6892770815679004},
              {"id":"id-45","name":"name-45","amount":0.07294290785770863},
              {"id":"id-46","name":"name-46","amount":0.08477882515776103},
              {"id":"id-47","name":"name-47","amount":0.3372187696443245},
              {"id":"id-48","name":"name-48","amount":0.9905748436639071},
              {"id":"id-49","name":"name-49","amount":0.8634308844337657},
              {"id":"id-50","name":"name-50","amount":0.4119886414566536},
              {"id":"id-51","name":"name-51","amount":0.604406863206473},
              {"id":"id-52","name":"name-52","amount":0.005031465318539929},
              {"id":"id-53","name":"name-53","amount":0.6600370183561287},
              {"id":"id-54","name":"name-54","amount":0.7898699107939339},
              {"id":"id-55","name":"name-55","amount":0.22918069135930574},
              {"id":"id-56","name":"name-56","amount":0.8388306569525853},
              {"id":"id-57","name":"name-57","amount":0.17134834057479487},
              {"id":"id-58","name":"name-58","amount":0.23549391089109994},
              {"id":"id-59","name":"name-59","amount":0.9890872085950219},
              {"id":"id-60","name":"name-60","amount":0.9270085102202333},
              {"id":"id-61","name":"name-61","amount":0.7142884717734761},
              {"id":"id-62","name":"name-62","amount":0.7467482524492535},
              {"id":"id-63","name":"name-63","amount":0.7228831942597134},
              {"id":"id-64","name":"name-64","amount":0.31120628080588364},
              {"id":"id-65","name":"name-65","amount":0.8627946639522867},
              {"id":"id-66","name":"name-66","amount":0.9640986383917548},
              {"id":"id-67","name":"name-67","amount":0.36288929391201685},
              {"id":"id-68","name":"name-68","amount":0.8006523607444572},
              {"id":"id-69","name":"name-69","amount":0.9024612922937798},
              {"id":"id-70","name":"name-70","amount":0.7327458998598809},
              {"id":"id-71","name":"name-71","amount":0.521067341347402},
              {"id":"id-72","name":"name-72","amount":0.8058329431176362},
              {"id":"id-73","name":"name-73","amount":0.9999935351287044},
              {"id":"id-74","name":"name-74","amount":0.6344227780231717},
              {"id":"id-75","name":"name-75","amount":0.16510650978856833},
              {"id":"id-76","name":"name-76","amount":0.04544289448691485},
              {"id":"id-77","name":"name-77","amount":0.665260849845376},
              {"id":"id-78","name":"name-78","amount":0.2973328387529859},
              {"id":"id-79","name":"name-79","amount":0.042873822521047766},
              {"id":"id-80","name":"name-80","amount":0.6445923564287787},
              {"id":"id-81","name":"name-81","amount":0.9089346799984689},
              {"id":"id-82","name":"name-82","amount":0.4382412631414462},
              {"id":"id-83","name":"name-83","amount":0.29190513899441894},
              {"id":"id-84","name":"name-84","amount":0.3658760968870476},
              {"id":"id-85","name":"name-85","amount":0.4801405210179439},
              {"id":"id-86","name":"name-86","amount":0.14248534712946237},
              {"id":"id-87","name":"name-87","amount":0.105183102549678},
              {"id":"id-88","name":"name-88","amount":0.8447965868391092},
              {"id":"id-89","name":"name-89","amount":0.7062492853609037},
              {"id":"id-90","name":"name-90","amount":0.8456806826834693},
              {"id":"id-91","name":"name-91","amount":0.41526830304207996},
              {"id":"id-92","name":"name-92","amount":0.7371637772427145},
              {"id":"id-93","name":"name-93","amount":0.7508788245428144},
              {"id":"id-94","name":"name-94","amount":0.8451560336414798},
              {"id":"id-95","name":"name-95","amount":0.3059210982640864},
              {"id":"id-96","name":"name-96","amount":0.6284777991378613},
              {"id":"id-97","name":"name-97","amount":0.5563712351544462},
              {"id":"id-98","name":"name-98","amount":0.9396584841394187},
              {"id":"id-99","name":"name-99","amount":0.263670963386443}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

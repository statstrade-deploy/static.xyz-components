      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.30343841316908793},
              {"id":"id-1","name":"name-1","amount":0.9445040037963934},
              {"id":"id-2","name":"name-2","amount":0.470726423308815},
              {"id":"id-3","name":"name-3","amount":0.41123536495827995},
              {"id":"id-4","name":"name-4","amount":0.9008454930462814},
              {"id":"id-5","name":"name-5","amount":0.10594113868514665},
              {"id":"id-6","name":"name-6","amount":0.09750249385241938},
              {"id":"id-7","name":"name-7","amount":0.8664205330270738},
              {"id":"id-8","name":"name-8","amount":0.9685908163759608},
              {"id":"id-9","name":"name-9","amount":0.34560747499736677},
              {"id":"id-10","name":"name-10","amount":0.5421073278612935},
              {"id":"id-11","name":"name-11","amount":0.9907924579080403},
              {"id":"id-12","name":"name-12","amount":0.9496398307255118},
              {"id":"id-13","name":"name-13","amount":0.5671636063577918},
              {"id":"id-14","name":"name-14","amount":0.23966324306953368},
              {"id":"id-15","name":"name-15","amount":0.08987854646701843},
              {"id":"id-16","name":"name-16","amount":0.6438142305458471},
              {"id":"id-17","name":"name-17","amount":0.4130830098407938},
              {"id":"id-18","name":"name-18","amount":0.8252787944539124},
              {"id":"id-19","name":"name-19","amount":0.118079932656449},
              {"id":"id-20","name":"name-20","amount":0.08180488207576642},
              {"id":"id-21","name":"name-21","amount":0.946417739871563},
              {"id":"id-22","name":"name-22","amount":0.9771535561637348},
              {"id":"id-23","name":"name-23","amount":0.9903299918779168},
              {"id":"id-24","name":"name-24","amount":0.03265805085168394},
              {"id":"id-25","name":"name-25","amount":0.5391652790894716},
              {"id":"id-26","name":"name-26","amount":0.8517286120288077},
              {"id":"id-27","name":"name-27","amount":0.6957671879750988},
              {"id":"id-28","name":"name-28","amount":0.8795067564432886},
              {"id":"id-29","name":"name-29","amount":0.13389303882312564},
              {"id":"id-30","name":"name-30","amount":0.25043973360250993},
              {"id":"id-31","name":"name-31","amount":0.13252031218421712},
              {"id":"id-32","name":"name-32","amount":0.259451899932157},
              {"id":"id-33","name":"name-33","amount":0.9642222497306602},
              {"id":"id-34","name":"name-34","amount":0.6468880421009491},
              {"id":"id-35","name":"name-35","amount":0.9547739502567505},
              {"id":"id-36","name":"name-36","amount":0.4308802249558168},
              {"id":"id-37","name":"name-37","amount":0.8949684997494483},
              {"id":"id-38","name":"name-38","amount":0.5987503549616214},
              {"id":"id-39","name":"name-39","amount":0.7516031994822084},
              {"id":"id-40","name":"name-40","amount":0.8051396431680418},
              {"id":"id-41","name":"name-41","amount":0.7741811869161807},
              {"id":"id-42","name":"name-42","amount":0.870509914083146},
              {"id":"id-43","name":"name-43","amount":0.5616359434194318},
              {"id":"id-44","name":"name-44","amount":0.45937459553147897},
              {"id":"id-45","name":"name-45","amount":0.577019746646017},
              {"id":"id-46","name":"name-46","amount":0.8010952479241129},
              {"id":"id-47","name":"name-47","amount":0.06842240210667472},
              {"id":"id-48","name":"name-48","amount":0.7334574502572879},
              {"id":"id-49","name":"name-49","amount":0.6653497181227171},
              {"id":"id-50","name":"name-50","amount":0.06477360317307101},
              {"id":"id-51","name":"name-51","amount":0.8184607986199312},
              {"id":"id-52","name":"name-52","amount":0.2063344447815556},
              {"id":"id-53","name":"name-53","amount":0.187136830573566},
              {"id":"id-54","name":"name-54","amount":0.9941519981652214},
              {"id":"id-55","name":"name-55","amount":0.4571495725560162},
              {"id":"id-56","name":"name-56","amount":0.44573755501274304},
              {"id":"id-57","name":"name-57","amount":0.4961631667496903},
              {"id":"id-58","name":"name-58","amount":0.060898402096493665},
              {"id":"id-59","name":"name-59","amount":0.2875055907393168},
              {"id":"id-60","name":"name-60","amount":0.9300965774715928},
              {"id":"id-61","name":"name-61","amount":0.48528390743334016},
              {"id":"id-62","name":"name-62","amount":0.9428014089718998},
              {"id":"id-63","name":"name-63","amount":0.42230930668252975},
              {"id":"id-64","name":"name-64","amount":0.45261854946784075},
              {"id":"id-65","name":"name-65","amount":0.895389410800846},
              {"id":"id-66","name":"name-66","amount":0.8450464888018189},
              {"id":"id-67","name":"name-67","amount":0.4224071539098133},
              {"id":"id-68","name":"name-68","amount":0.13488412599463928},
              {"id":"id-69","name":"name-69","amount":0.9874320067161911},
              {"id":"id-70","name":"name-70","amount":0.3890931741593384},
              {"id":"id-71","name":"name-71","amount":0.5922225580821541},
              {"id":"id-72","name":"name-72","amount":0.9009438418624092},
              {"id":"id-73","name":"name-73","amount":0.44632245151518646},
              {"id":"id-74","name":"name-74","amount":0.43429648731005743},
              {"id":"id-75","name":"name-75","amount":0.03809658539740857},
              {"id":"id-76","name":"name-76","amount":0.892779510698377},
              {"id":"id-77","name":"name-77","amount":0.023196316372362524},
              {"id":"id-78","name":"name-78","amount":0.6554228825605453},
              {"id":"id-79","name":"name-79","amount":0.18589998787230344},
              {"id":"id-80","name":"name-80","amount":0.8441292710561157},
              {"id":"id-81","name":"name-81","amount":0.21649602954977376},
              {"id":"id-82","name":"name-82","amount":0.5634693528065481},
              {"id":"id-83","name":"name-83","amount":0.7014289336473325},
              {"id":"id-84","name":"name-84","amount":0.8720571213658549},
              {"id":"id-85","name":"name-85","amount":0.24250899544158933},
              {"id":"id-86","name":"name-86","amount":0.927701893322854},
              {"id":"id-87","name":"name-87","amount":0.6604159495043569},
              {"id":"id-88","name":"name-88","amount":0.49428118656673925},
              {"id":"id-89","name":"name-89","amount":0.6524486002399036},
              {"id":"id-90","name":"name-90","amount":0.23358737701288146},
              {"id":"id-91","name":"name-91","amount":0.3745596213678076},
              {"id":"id-92","name":"name-92","amount":0.9351570905143075},
              {"id":"id-93","name":"name-93","amount":0.21585896194210819},
              {"id":"id-94","name":"name-94","amount":0.8943008650112966},
              {"id":"id-95","name":"name-95","amount":0.49579495937207163},
              {"id":"id-96","name":"name-96","amount":0.9443463220569127},
              {"id":"id-97","name":"name-97","amount":0.10907071496653442},
              {"id":"id-98","name":"name-98","amount":0.42274776925386304},
              {"id":"id-99","name":"name-99","amount":0.8930985920086375}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

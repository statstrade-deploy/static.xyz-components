      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.46720606828572353},
              {"id":"id-1","name":"name-1","amount":0.07128115781735533},
              {"id":"id-2","name":"name-2","amount":0.5859001041491294},
              {"id":"id-3","name":"name-3","amount":0.8024396436777756},
              {"id":"id-4","name":"name-4","amount":0.20443962578533614},
              {"id":"id-5","name":"name-5","amount":0.4692972409791041},
              {"id":"id-6","name":"name-6","amount":0.026653095194371645},
              {"id":"id-7","name":"name-7","amount":0.9587130742601077},
              {"id":"id-8","name":"name-8","amount":0.9277101017644461},
              {"id":"id-9","name":"name-9","amount":0.931027575882998},
              {"id":"id-10","name":"name-10","amount":0.973542984941852},
              {"id":"id-11","name":"name-11","amount":0.7483218622309646},
              {"id":"id-12","name":"name-12","amount":0.07420193010579357},
              {"id":"id-13","name":"name-13","amount":0.05483885810176148},
              {"id":"id-14","name":"name-14","amount":0.6161827477079017},
              {"id":"id-15","name":"name-15","amount":0.037574163035253516},
              {"id":"id-16","name":"name-16","amount":0.21691077885506427},
              {"id":"id-17","name":"name-17","amount":0.4522551240872913},
              {"id":"id-18","name":"name-18","amount":0.20658983967373445},
              {"id":"id-19","name":"name-19","amount":0.7957206445199307},
              {"id":"id-20","name":"name-20","amount":0.7374742722050885},
              {"id":"id-21","name":"name-21","amount":0.7793550131591918},
              {"id":"id-22","name":"name-22","amount":0.1703662223677297},
              {"id":"id-23","name":"name-23","amount":0.32709499970279343},
              {"id":"id-24","name":"name-24","amount":0.9179757790852436},
              {"id":"id-25","name":"name-25","amount":0.33113156670452915},
              {"id":"id-26","name":"name-26","amount":0.5130261810683128},
              {"id":"id-27","name":"name-27","amount":0.07239665046837995},
              {"id":"id-28","name":"name-28","amount":0.7970883703744333},
              {"id":"id-29","name":"name-29","amount":0.6030198670024357},
              {"id":"id-30","name":"name-30","amount":0.7286560377929115},
              {"id":"id-31","name":"name-31","amount":0.1240439359633898},
              {"id":"id-32","name":"name-32","amount":0.02362225718194333},
              {"id":"id-33","name":"name-33","amount":0.9318056406134628},
              {"id":"id-34","name":"name-34","amount":0.25890950271266455},
              {"id":"id-35","name":"name-35","amount":0.3866583285284263},
              {"id":"id-36","name":"name-36","amount":0.9844829983578887},
              {"id":"id-37","name":"name-37","amount":0.44238588229893083},
              {"id":"id-38","name":"name-38","amount":0.04741360964374508},
              {"id":"id-39","name":"name-39","amount":0.0061233300749794495},
              {"id":"id-40","name":"name-40","amount":0.6842447367114336},
              {"id":"id-41","name":"name-41","amount":0.04736004361698887},
              {"id":"id-42","name":"name-42","amount":0.8879796922612325},
              {"id":"id-43","name":"name-43","amount":0.2892945553093137},
              {"id":"id-44","name":"name-44","amount":0.2099863424358389},
              {"id":"id-45","name":"name-45","amount":0.17318859757490035},
              {"id":"id-46","name":"name-46","amount":0.07458446437752853},
              {"id":"id-47","name":"name-47","amount":0.8413201647229422},
              {"id":"id-48","name":"name-48","amount":0.1277349419581496},
              {"id":"id-49","name":"name-49","amount":0.21966322767578672},
              {"id":"id-50","name":"name-50","amount":0.32690683753614436},
              {"id":"id-51","name":"name-51","amount":0.05866374664982832},
              {"id":"id-52","name":"name-52","amount":0.8258060479706163},
              {"id":"id-53","name":"name-53","amount":0.49869086728954704},
              {"id":"id-54","name":"name-54","amount":0.08727610585147216},
              {"id":"id-55","name":"name-55","amount":0.4333043380845679},
              {"id":"id-56","name":"name-56","amount":0.6455247510453651},
              {"id":"id-57","name":"name-57","amount":0.5439015437403572},
              {"id":"id-58","name":"name-58","amount":0.06320729653394908},
              {"id":"id-59","name":"name-59","amount":0.34722139753210324},
              {"id":"id-60","name":"name-60","amount":0.6212580359717742},
              {"id":"id-61","name":"name-61","amount":0.23434802708117786},
              {"id":"id-62","name":"name-62","amount":0.32427031661615713},
              {"id":"id-63","name":"name-63","amount":0.16615530584830696},
              {"id":"id-64","name":"name-64","amount":0.7893835911364083},
              {"id":"id-65","name":"name-65","amount":0.13357266274242774},
              {"id":"id-66","name":"name-66","amount":0.35285953192275055},
              {"id":"id-67","name":"name-67","amount":0.4777663579309177},
              {"id":"id-68","name":"name-68","amount":0.31976524846960386},
              {"id":"id-69","name":"name-69","amount":0.8095750596204843},
              {"id":"id-70","name":"name-70","amount":0.19550041286953113},
              {"id":"id-71","name":"name-71","amount":0.261698739150219},
              {"id":"id-72","name":"name-72","amount":0.17350148107114416},
              {"id":"id-73","name":"name-73","amount":0.6717217523749464},
              {"id":"id-74","name":"name-74","amount":0.26465097592042874},
              {"id":"id-75","name":"name-75","amount":0.6276880478653526},
              {"id":"id-76","name":"name-76","amount":0.5971576640247166},
              {"id":"id-77","name":"name-77","amount":0.037397004144267165},
              {"id":"id-78","name":"name-78","amount":0.40052530197006264},
              {"id":"id-79","name":"name-79","amount":0.5127343157723613},
              {"id":"id-80","name":"name-80","amount":0.5263888709130928},
              {"id":"id-81","name":"name-81","amount":0.7242015502884712},
              {"id":"id-82","name":"name-82","amount":0.5182870461583194},
              {"id":"id-83","name":"name-83","amount":0.38949507520909654},
              {"id":"id-84","name":"name-84","amount":0.8908049433279593},
              {"id":"id-85","name":"name-85","amount":0.45276402038095764},
              {"id":"id-86","name":"name-86","amount":0.5380313606679408},
              {"id":"id-87","name":"name-87","amount":0.6054356762661792},
              {"id":"id-88","name":"name-88","amount":0.8871247892357137},
              {"id":"id-89","name":"name-89","amount":0.7407376270686611},
              {"id":"id-90","name":"name-90","amount":0.3232935411681399},
              {"id":"id-91","name":"name-91","amount":0.4459070944478144},
              {"id":"id-92","name":"name-92","amount":0.5191127258435215},
              {"id":"id-93","name":"name-93","amount":0.7703121785778675},
              {"id":"id-94","name":"name-94","amount":0.0383933198512697},
              {"id":"id-95","name":"name-95","amount":0.3942042658426701},
              {"id":"id-96","name":"name-96","amount":0.09048418685290116},
              {"id":"id-97","name":"name-97","amount":0.9195800168755768},
              {"id":"id-98","name":"name-98","amount":0.6757439309773028},
              {"id":"id-99","name":"name-99","amount":0.34779067541367914}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

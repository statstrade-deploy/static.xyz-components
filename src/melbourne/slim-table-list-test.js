      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.28673807903416904},
              {"id":"id-1","name":"name-1","amount":0.9717494536763567},
              {"id":"id-2","name":"name-2","amount":0.9634787831328615},
              {"id":"id-3","name":"name-3","amount":0.3259078417068376},
              {"id":"id-4","name":"name-4","amount":0.933363992357165},
              {"id":"id-5","name":"name-5","amount":0.810609855949627},
              {"id":"id-6","name":"name-6","amount":0.39767075531034246},
              {"id":"id-7","name":"name-7","amount":0.3593334497073679},
              {"id":"id-8","name":"name-8","amount":0.15220301419095383},
              {"id":"id-9","name":"name-9","amount":0.12596780521898676},
              {"id":"id-10","name":"name-10","amount":0.45935638195411},
              {"id":"id-11","name":"name-11","amount":0.08978304245485014},
              {"id":"id-12","name":"name-12","amount":0.3294676314367413},
              {"id":"id-13","name":"name-13","amount":0.7485794507702284},
              {"id":"id-14","name":"name-14","amount":0.8945569136318031},
              {"id":"id-15","name":"name-15","amount":0.8818091799864328},
              {"id":"id-16","name":"name-16","amount":0.8519769838609198},
              {"id":"id-17","name":"name-17","amount":0.9598269267068459},
              {"id":"id-18","name":"name-18","amount":0.9359871827555991},
              {"id":"id-19","name":"name-19","amount":0.8161408878642196},
              {"id":"id-20","name":"name-20","amount":0.8787828788574713},
              {"id":"id-21","name":"name-21","amount":0.06257614658941701},
              {"id":"id-22","name":"name-22","amount":0.32657421878583326},
              {"id":"id-23","name":"name-23","amount":0.5542315054338033},
              {"id":"id-24","name":"name-24","amount":0.04908360324043182},
              {"id":"id-25","name":"name-25","amount":0.1592347866189363},
              {"id":"id-26","name":"name-26","amount":0.5311100061603193},
              {"id":"id-27","name":"name-27","amount":0.5804323347308055},
              {"id":"id-28","name":"name-28","amount":0.5620032416639271},
              {"id":"id-29","name":"name-29","amount":0.9507611471501463},
              {"id":"id-30","name":"name-30","amount":0.7830417088354814},
              {"id":"id-31","name":"name-31","amount":0.08524968840609759},
              {"id":"id-32","name":"name-32","amount":0.7444774943230549},
              {"id":"id-33","name":"name-33","amount":0.34010259321669256},
              {"id":"id-34","name":"name-34","amount":0.934691338349067},
              {"id":"id-35","name":"name-35","amount":0.988495602510964},
              {"id":"id-36","name":"name-36","amount":0.43540181796843247},
              {"id":"id-37","name":"name-37","amount":0.3745169054104228},
              {"id":"id-38","name":"name-38","amount":0.4317364401646163},
              {"id":"id-39","name":"name-39","amount":0.11774353300635687},
              {"id":"id-40","name":"name-40","amount":0.25736148626734623},
              {"id":"id-41","name":"name-41","amount":0.5934583201432159},
              {"id":"id-42","name":"name-42","amount":0.11657205308987806},
              {"id":"id-43","name":"name-43","amount":0.35535180509237274},
              {"id":"id-44","name":"name-44","amount":0.12167690634524786},
              {"id":"id-45","name":"name-45","amount":0.16218501636354044},
              {"id":"id-46","name":"name-46","amount":0.980213314780645},
              {"id":"id-47","name":"name-47","amount":0.6464193573893229},
              {"id":"id-48","name":"name-48","amount":0.1181623406287764},
              {"id":"id-49","name":"name-49","amount":0.26597278130546365},
              {"id":"id-50","name":"name-50","amount":0.42868718081203905},
              {"id":"id-51","name":"name-51","amount":0.12039007591358031},
              {"id":"id-52","name":"name-52","amount":0.2779094591823287},
              {"id":"id-53","name":"name-53","amount":0.115794704658709},
              {"id":"id-54","name":"name-54","amount":0.10740097433504359},
              {"id":"id-55","name":"name-55","amount":0.22062303042402875},
              {"id":"id-56","name":"name-56","amount":0.5655715995957973},
              {"id":"id-57","name":"name-57","amount":0.5735547605128173},
              {"id":"id-58","name":"name-58","amount":0.8357642471871228},
              {"id":"id-59","name":"name-59","amount":0.6590979217019347},
              {"id":"id-60","name":"name-60","amount":0.8570388235311287},
              {"id":"id-61","name":"name-61","amount":0.8434384218087272},
              {"id":"id-62","name":"name-62","amount":0.744379635364085},
              {"id":"id-63","name":"name-63","amount":0.2175266815639304},
              {"id":"id-64","name":"name-64","amount":0.5890574438396308},
              {"id":"id-65","name":"name-65","amount":0.8956710345184907},
              {"id":"id-66","name":"name-66","amount":0.278407346532516},
              {"id":"id-67","name":"name-67","amount":0.9014931845747673},
              {"id":"id-68","name":"name-68","amount":0.22926238225518547},
              {"id":"id-69","name":"name-69","amount":0.28995052015367373},
              {"id":"id-70","name":"name-70","amount":0.333247459233167},
              {"id":"id-71","name":"name-71","amount":0.7208452494652628},
              {"id":"id-72","name":"name-72","amount":0.7082540612602506},
              {"id":"id-73","name":"name-73","amount":0.8480478768935876},
              {"id":"id-74","name":"name-74","amount":0.422472316037692},
              {"id":"id-75","name":"name-75","amount":0.41741411518328786},
              {"id":"id-76","name":"name-76","amount":0.479766231921955},
              {"id":"id-77","name":"name-77","amount":0.18854554071901097},
              {"id":"id-78","name":"name-78","amount":0.44298150265047676},
              {"id":"id-79","name":"name-79","amount":0.7902388300033406},
              {"id":"id-80","name":"name-80","amount":0.9306348379212225},
              {"id":"id-81","name":"name-81","amount":0.48141006764478356},
              {"id":"id-82","name":"name-82","amount":0.29863994516069914},
              {"id":"id-83","name":"name-83","amount":0.8788234076528444},
              {"id":"id-84","name":"name-84","amount":0.4491922494683108},
              {"id":"id-85","name":"name-85","amount":0.9060721342911372},
              {"id":"id-86","name":"name-86","amount":0.37119949205610825},
              {"id":"id-87","name":"name-87","amount":0.15655763742799567},
              {"id":"id-88","name":"name-88","amount":0.5788751944530439},
              {"id":"id-89","name":"name-89","amount":0.2039138097409291},
              {"id":"id-90","name":"name-90","amount":0.5860929810758893},
              {"id":"id-91","name":"name-91","amount":0.05928273625190761},
              {"id":"id-92","name":"name-92","amount":0.33324855742430626},
              {"id":"id-93","name":"name-93","amount":0.4045389516831064},
              {"id":"id-94","name":"name-94","amount":0.6107288179296558},
              {"id":"id-95","name":"name-95","amount":0.6280852338340683},
              {"id":"id-96","name":"name-96","amount":0.9293119678135129},
              {"id":"id-97","name":"name-97","amount":0.2749297637240631},
              {"id":"id-98","name":"name-98","amount":0.5442036037500345},
              {"id":"id-99","name":"name-99","amount":0.7807539798195594}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

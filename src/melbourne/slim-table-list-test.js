      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.7652057397688027},
              {"id":"id-1","name":"name-1","amount":0.7215361930837921},
              {"id":"id-2","name":"name-2","amount":0.4244362211515029},
              {"id":"id-3","name":"name-3","amount":0.8761632541631975},
              {"id":"id-4","name":"name-4","amount":0.7550755611053221},
              {"id":"id-5","name":"name-5","amount":0.8217042249532406},
              {"id":"id-6","name":"name-6","amount":0.6803447996406975},
              {"id":"id-7","name":"name-7","amount":0.5158709149443297},
              {"id":"id-8","name":"name-8","amount":0.6361713949547024},
              {"id":"id-9","name":"name-9","amount":0.8835660411708673},
              {"id":"id-10","name":"name-10","amount":0.2687107550014306},
              {"id":"id-11","name":"name-11","amount":0.6626672608831633},
              {"id":"id-12","name":"name-12","amount":0.32174846890994835},
              {"id":"id-13","name":"name-13","amount":9.017957813107769E-4},
              {"id":"id-14","name":"name-14","amount":0.6493043993028748},
              {"id":"id-15","name":"name-15","amount":0.9345233820390131},
              {"id":"id-16","name":"name-16","amount":0.2003695049616162},
              {"id":"id-17","name":"name-17","amount":0.31921983443763957},
              {"id":"id-18","name":"name-18","amount":0.666749611949656},
              {"id":"id-19","name":"name-19","amount":0.16022416745208146},
              {"id":"id-20","name":"name-20","amount":0.9772891804758699},
              {"id":"id-21","name":"name-21","amount":0.2631087307498985},
              {"id":"id-22","name":"name-22","amount":0.8812448262378996},
              {"id":"id-23","name":"name-23","amount":0.6884677851703646},
              {"id":"id-24","name":"name-24","amount":0.8623477175077927},
              {"id":"id-25","name":"name-25","amount":0.2100204867447859},
              {"id":"id-26","name":"name-26","amount":0.6383254495275974},
              {"id":"id-27","name":"name-27","amount":0.24210562284486237},
              {"id":"id-28","name":"name-28","amount":0.5566744289245196},
              {"id":"id-29","name":"name-29","amount":0.9927175563402959},
              {"id":"id-30","name":"name-30","amount":0.5277224265010111},
              {"id":"id-31","name":"name-31","amount":0.7139152252977143},
              {"id":"id-32","name":"name-32","amount":0.42507256151391737},
              {"id":"id-33","name":"name-33","amount":0.24249919538433462},
              {"id":"id-34","name":"name-34","amount":0.5190675040495955},
              {"id":"id-35","name":"name-35","amount":0.7583068822920807},
              {"id":"id-36","name":"name-36","amount":0.8317772362673118},
              {"id":"id-37","name":"name-37","amount":0.12145545338955377},
              {"id":"id-38","name":"name-38","amount":0.8561403541728171},
              {"id":"id-39","name":"name-39","amount":0.8976225066372964},
              {"id":"id-40","name":"name-40","amount":0.8643482473142785},
              {"id":"id-41","name":"name-41","amount":0.43437973670514685},
              {"id":"id-42","name":"name-42","amount":0.7415486804856263},
              {"id":"id-43","name":"name-43","amount":0.13219291231783814},
              {"id":"id-44","name":"name-44","amount":0.5737801207455437},
              {"id":"id-45","name":"name-45","amount":0.4596040802616773},
              {"id":"id-46","name":"name-46","amount":0.9501775542441955},
              {"id":"id-47","name":"name-47","amount":0.7200775976212512},
              {"id":"id-48","name":"name-48","amount":0.4184820799029473},
              {"id":"id-49","name":"name-49","amount":0.09290379860845},
              {"id":"id-50","name":"name-50","amount":0.7724391826652816},
              {"id":"id-51","name":"name-51","amount":0.8754188247933568},
              {"id":"id-52","name":"name-52","amount":0.8156005189513502},
              {"id":"id-53","name":"name-53","amount":0.0597509110018426},
              {"id":"id-54","name":"name-54","amount":0.10730025312261215},
              {"id":"id-55","name":"name-55","amount":0.6235999106268605},
              {"id":"id-56","name":"name-56","amount":0.5752277119901166},
              {"id":"id-57","name":"name-57","amount":0.018578843512485066},
              {"id":"id-58","name":"name-58","amount":0.10025865657754085},
              {"id":"id-59","name":"name-59","amount":0.9469050989059824},
              {"id":"id-60","name":"name-60","amount":0.5213596662686636},
              {"id":"id-61","name":"name-61","amount":0.351353643539984},
              {"id":"id-62","name":"name-62","amount":0.45288724593361174},
              {"id":"id-63","name":"name-63","amount":0.6561362188662039},
              {"id":"id-64","name":"name-64","amount":0.7880374822701928},
              {"id":"id-65","name":"name-65","amount":0.31762935836068684},
              {"id":"id-66","name":"name-66","amount":0.4182573629423558},
              {"id":"id-67","name":"name-67","amount":0.13164958848817443},
              {"id":"id-68","name":"name-68","amount":0.11992613819493314},
              {"id":"id-69","name":"name-69","amount":0.03439884930520287},
              {"id":"id-70","name":"name-70","amount":0.5405000201967862},
              {"id":"id-71","name":"name-71","amount":0.191533703103982},
              {"id":"id-72","name":"name-72","amount":0.003655058226202934},
              {"id":"id-73","name":"name-73","amount":0.4364331119323296},
              {"id":"id-74","name":"name-74","amount":0.3969583145656672},
              {"id":"id-75","name":"name-75","amount":0.8651569151671904},
              {"id":"id-76","name":"name-76","amount":0.6095654972482315},
              {"id":"id-77","name":"name-77","amount":0.9704360691400606},
              {"id":"id-78","name":"name-78","amount":0.9578295042388791},
              {"id":"id-79","name":"name-79","amount":0.7770712371663371},
              {"id":"id-80","name":"name-80","amount":0.3330796512238543},
              {"id":"id-81","name":"name-81","amount":0.2812235218992162},
              {"id":"id-82","name":"name-82","amount":0.6908911107207129},
              {"id":"id-83","name":"name-83","amount":0.17926696910856088},
              {"id":"id-84","name":"name-84","amount":0.19072695744785928},
              {"id":"id-85","name":"name-85","amount":0.5592687578442042},
              {"id":"id-86","name":"name-86","amount":0.2078499360309446},
              {"id":"id-87","name":"name-87","amount":0.40903024844622204},
              {"id":"id-88","name":"name-88","amount":0.4479331945831626},
              {"id":"id-89","name":"name-89","amount":0.5363393570065705},
              {"id":"id-90","name":"name-90","amount":0.07404899428531553},
              {"id":"id-91","name":"name-91","amount":0.6951634828925122},
              {"id":"id-92","name":"name-92","amount":0.633998637732945},
              {"id":"id-93","name":"name-93","amount":0.33958303636722686},
              {"id":"id-94","name":"name-94","amount":0.3847118717802185},
              {"id":"id-95","name":"name-95","amount":0.7870864784349901},
              {"id":"id-96","name":"name-96","amount":0.534261342599053},
              {"id":"id-97","name":"name-97","amount":0.5443029736792616},
              {"id":"id-98","name":"name-98","amount":0.8486002885610997},
              {"id":"id-99","name":"name-99","amount":0.8393440948226266}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

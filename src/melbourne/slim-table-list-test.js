      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.6965842602865842},
              {"id":"id-1","name":"name-1","amount":0.15199723536146004},
              {"id":"id-2","name":"name-2","amount":0.9827665859725708},
              {"id":"id-3","name":"name-3","amount":0.9865536758043861},
              {"id":"id-4","name":"name-4","amount":0.8521693428804316},
              {"id":"id-5","name":"name-5","amount":0.7739604018913887},
              {"id":"id-6","name":"name-6","amount":0.8872595858005754},
              {"id":"id-7","name":"name-7","amount":0.628570683617325},
              {"id":"id-8","name":"name-8","amount":0.2707950822247185},
              {"id":"id-9","name":"name-9","amount":0.007158631868226739},
              {"id":"id-10","name":"name-10","amount":0.7883158404224555},
              {"id":"id-11","name":"name-11","amount":0.08911348842996625},
              {"id":"id-12","name":"name-12","amount":0.7702250273129935},
              {"id":"id-13","name":"name-13","amount":0.50612428227493},
              {"id":"id-14","name":"name-14","amount":0.5202219984558247},
              {"id":"id-15","name":"name-15","amount":0.04396388237012716},
              {"id":"id-16","name":"name-16","amount":0.9815353911883725},
              {"id":"id-17","name":"name-17","amount":0.4250682009530026},
              {"id":"id-18","name":"name-18","amount":0.8163886168225468},
              {"id":"id-19","name":"name-19","amount":0.1993728309132703},
              {"id":"id-20","name":"name-20","amount":0.5855781403459575},
              {"id":"id-21","name":"name-21","amount":0.7795405726174693},
              {"id":"id-22","name":"name-22","amount":0.8227454350094441},
              {"id":"id-23","name":"name-23","amount":0.6781394611757621},
              {"id":"id-24","name":"name-24","amount":0.9012897774021223},
              {"id":"id-25","name":"name-25","amount":0.47699205382612553},
              {"id":"id-26","name":"name-26","amount":0.2309422155052584},
              {"id":"id-27","name":"name-27","amount":0.18691059303098223},
              {"id":"id-28","name":"name-28","amount":0.426462492110557},
              {"id":"id-29","name":"name-29","amount":0.6590883264513185},
              {"id":"id-30","name":"name-30","amount":0.23402183744948424},
              {"id":"id-31","name":"name-31","amount":0.07288566794345608},
              {"id":"id-32","name":"name-32","amount":0.6435077641236115},
              {"id":"id-33","name":"name-33","amount":0.24960720822042648},
              {"id":"id-34","name":"name-34","amount":0.3597725020738025},
              {"id":"id-35","name":"name-35","amount":0.39471306539546125},
              {"id":"id-36","name":"name-36","amount":0.6459075916503647},
              {"id":"id-37","name":"name-37","amount":0.6339743792082349},
              {"id":"id-38","name":"name-38","amount":0.12075402975531746},
              {"id":"id-39","name":"name-39","amount":0.43021604422466264},
              {"id":"id-40","name":"name-40","amount":0.9154612849375918},
              {"id":"id-41","name":"name-41","amount":0.20996993094938676},
              {"id":"id-42","name":"name-42","amount":0.335032935315944},
              {"id":"id-43","name":"name-43","amount":0.6226879540481232},
              {"id":"id-44","name":"name-44","amount":0.8861012239877537},
              {"id":"id-45","name":"name-45","amount":0.14386513803363676},
              {"id":"id-46","name":"name-46","amount":0.9179495187804706},
              {"id":"id-47","name":"name-47","amount":0.8278472133395964},
              {"id":"id-48","name":"name-48","amount":0.7669638164147146},
              {"id":"id-49","name":"name-49","amount":0.04222470646499532},
              {"id":"id-50","name":"name-50","amount":0.92277973401307},
              {"id":"id-51","name":"name-51","amount":0.8651454235542161},
              {"id":"id-52","name":"name-52","amount":0.46556684239239576},
              {"id":"id-53","name":"name-53","amount":0.40683693601586235},
              {"id":"id-54","name":"name-54","amount":0.6169433093490103},
              {"id":"id-55","name":"name-55","amount":0.7999722188940969},
              {"id":"id-56","name":"name-56","amount":0.3513577437859975},
              {"id":"id-57","name":"name-57","amount":0.6787102567949894},
              {"id":"id-58","name":"name-58","amount":0.42044889323418},
              {"id":"id-59","name":"name-59","amount":0.08740276254805524},
              {"id":"id-60","name":"name-60","amount":0.030562273408977658},
              {"id":"id-61","name":"name-61","amount":0.39680168354660394},
              {"id":"id-62","name":"name-62","amount":0.6045558856019898},
              {"id":"id-63","name":"name-63","amount":0.6934855997166003},
              {"id":"id-64","name":"name-64","amount":0.2651759300615717},
              {"id":"id-65","name":"name-65","amount":0.4981187588423883},
              {"id":"id-66","name":"name-66","amount":0.7511717777086554},
              {"id":"id-67","name":"name-67","amount":0.5766688521705651},
              {"id":"id-68","name":"name-68","amount":0.6621058484964174},
              {"id":"id-69","name":"name-69","amount":0.06806373369007424},
              {"id":"id-70","name":"name-70","amount":0.107292886884781},
              {"id":"id-71","name":"name-71","amount":0.45981631646448684},
              {"id":"id-72","name":"name-72","amount":0.7828838650789539},
              {"id":"id-73","name":"name-73","amount":0.9133645279648094},
              {"id":"id-74","name":"name-74","amount":0.13383530834121904},
              {"id":"id-75","name":"name-75","amount":0.6523645172581347},
              {"id":"id-76","name":"name-76","amount":0.8800361245596354},
              {"id":"id-77","name":"name-77","amount":0.17466443350671534},
              {"id":"id-78","name":"name-78","amount":0.7444923247379978},
              {"id":"id-79","name":"name-79","amount":0.7925248127871296},
              {"id":"id-80","name":"name-80","amount":0.5531086107786111},
              {"id":"id-81","name":"name-81","amount":0.8218183957728632},
              {"id":"id-82","name":"name-82","amount":0.9577929255705583},
              {"id":"id-83","name":"name-83","amount":0.7710354697158535},
              {"id":"id-84","name":"name-84","amount":0.23551164250228818},
              {"id":"id-85","name":"name-85","amount":0.28217050917700714},
              {"id":"id-86","name":"name-86","amount":0.944325981041542},
              {"id":"id-87","name":"name-87","amount":0.7708205274605876},
              {"id":"id-88","name":"name-88","amount":0.5727609564449655},
              {"id":"id-89","name":"name-89","amount":0.6405641926261488},
              {"id":"id-90","name":"name-90","amount":0.7411328150216013},
              {"id":"id-91","name":"name-91","amount":0.3110134694487192},
              {"id":"id-92","name":"name-92","amount":0.43335686372977733},
              {"id":"id-93","name":"name-93","amount":0.8195625110020242},
              {"id":"id-94","name":"name-94","amount":0.22656090092970393},
              {"id":"id-95","name":"name-95","amount":0.41915596901791696},
              {"id":"id-96","name":"name-96","amount":0.5054566798356401},
              {"id":"id-97","name":"name-97","amount":0.8993332721935037},
              {"id":"id-98","name":"name-98","amount":0.301409422690727},
              {"id":"id-99","name":"name-99","amount":0.5719824346356266}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

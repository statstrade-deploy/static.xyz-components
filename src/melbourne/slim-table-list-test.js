      ...
      <ReactNative.View>
        <ui_static.Div design={{"type":"light"}} style={{"flex":1,"padding":5}}>
          <slim_table_list.TableListViewPaged
            ...
            entries={[
              {"id":"id-0","name":"name-0","amount":0.09519328196307353},
              {"id":"id-1","name":"name-1","amount":0.6479057921612005},
              {"id":"id-2","name":"name-2","amount":0.5276110921906831},
              {"id":"id-3","name":"name-3","amount":0.9188190844483272},
              {"id":"id-4","name":"name-4","amount":0.46575379113981374},
              {"id":"id-5","name":"name-5","amount":0.21340825751918768},
              {"id":"id-6","name":"name-6","amount":0.7494700340307232},
              {"id":"id-7","name":"name-7","amount":0.7736415164451866},
              {"id":"id-8","name":"name-8","amount":0.6523186490416912},
              {"id":"id-9","name":"name-9","amount":0.39600005774806146},
              {"id":"id-10","name":"name-10","amount":0.46481975918863316},
              {"id":"id-11","name":"name-11","amount":0.677127240733101},
              {"id":"id-12","name":"name-12","amount":0.6394026134703598},
              {"id":"id-13","name":"name-13","amount":0.7738827244896465},
              {"id":"id-14","name":"name-14","amount":0.16881783348345225},
              {"id":"id-15","name":"name-15","amount":0.4406594904742419},
              {"id":"id-16","name":"name-16","amount":0.7137198640925607},
              {"id":"id-17","name":"name-17","amount":0.19871362441013185},
              {"id":"id-18","name":"name-18","amount":0.8879509742964805},
              {"id":"id-19","name":"name-19","amount":0.8737607683626121},
              {"id":"id-20","name":"name-20","amount":0.8183749708182947},
              {"id":"id-21","name":"name-21","amount":0.4023732139212044},
              {"id":"id-22","name":"name-22","amount":0.40214282508663235},
              {"id":"id-23","name":"name-23","amount":0.38855647850216934},
              {"id":"id-24","name":"name-24","amount":0.6358758731800082},
              {"id":"id-25","name":"name-25","amount":0.9137078271197019},
              {"id":"id-26","name":"name-26","amount":0.5518996925138586},
              {"id":"id-27","name":"name-27","amount":0.23100179619176664},
              {"id":"id-28","name":"name-28","amount":0.995457960354227},
              {"id":"id-29","name":"name-29","amount":0.2647708520018597},
              {"id":"id-30","name":"name-30","amount":0.05850375360112703},
              {"id":"id-31","name":"name-31","amount":0.9829456084102154},
              {"id":"id-32","name":"name-32","amount":0.0605603998526838},
              {"id":"id-33","name":"name-33","amount":0.3029989848726189},
              {"id":"id-34","name":"name-34","amount":0.6612388265629036},
              {"id":"id-35","name":"name-35","amount":0.9566434673917207},
              {"id":"id-36","name":"name-36","amount":0.8938976926559137},
              {"id":"id-37","name":"name-37","amount":0.7939243843610887},
              {"id":"id-38","name":"name-38","amount":0.5328613395059569},
              {"id":"id-39","name":"name-39","amount":0.11212191011128803},
              {"id":"id-40","name":"name-40","amount":0.42041999058723156},
              {"id":"id-41","name":"name-41","amount":0.39843776595387226},
              {"id":"id-42","name":"name-42","amount":0.8730048859751491},
              {"id":"id-43","name":"name-43","amount":0.16783418607015665},
              {"id":"id-44","name":"name-44","amount":0.5125586339123188},
              {"id":"id-45","name":"name-45","amount":0.5392810851139866},
              {"id":"id-46","name":"name-46","amount":0.2989336906037583},
              {"id":"id-47","name":"name-47","amount":0.6463374857788348},
              {"id":"id-48","name":"name-48","amount":0.9075037063137784},
              {"id":"id-49","name":"name-49","amount":0.633363105893424},
              {"id":"id-50","name":"name-50","amount":0.15403700632448725},
              {"id":"id-51","name":"name-51","amount":0.6992603729837913},
              {"id":"id-52","name":"name-52","amount":0.9328626904840112},
              {"id":"id-53","name":"name-53","amount":0.659654950024554},
              {"id":"id-54","name":"name-54","amount":0.13668274788971668},
              {"id":"id-55","name":"name-55","amount":0.6896182470254151},
              {"id":"id-56","name":"name-56","amount":0.5649007689876044},
              {"id":"id-57","name":"name-57","amount":0.056836443649922685},
              {"id":"id-58","name":"name-58","amount":0.715525190488848},
              {"id":"id-59","name":"name-59","amount":0.6745738209123324},
              {"id":"id-60","name":"name-60","amount":0.1726643988009705},
              {"id":"id-61","name":"name-61","amount":0.5005288427086633},
              {"id":"id-62","name":"name-62","amount":0.6420885952576553},
              {"id":"id-63","name":"name-63","amount":0.12802849772734315},
              {"id":"id-64","name":"name-64","amount":0.4116422821815471},
              {"id":"id-65","name":"name-65","amount":0.19686298405838365},
              {"id":"id-66","name":"name-66","amount":0.49742449651937726},
              {"id":"id-67","name":"name-67","amount":0.469969907901162},
              {"id":"id-68","name":"name-68","amount":0.1222183041821},
              {"id":"id-69","name":"name-69","amount":0.9472962681447342},
              {"id":"id-70","name":"name-70","amount":0.616867527569093},
              {"id":"id-71","name":"name-71","amount":0.22828937669616833},
              {"id":"id-72","name":"name-72","amount":0.7610234911256946},
              {"id":"id-73","name":"name-73","amount":0.3890058489370233},
              {"id":"id-74","name":"name-74","amount":0.9253910610549901},
              {"id":"id-75","name":"name-75","amount":0.9488229303053193},
              {"id":"id-76","name":"name-76","amount":0.8473950480197072},
              {"id":"id-77","name":"name-77","amount":0.495849509467877},
              {"id":"id-78","name":"name-78","amount":0.18579013296424673},
              {"id":"id-79","name":"name-79","amount":0.29065761025672254},
              {"id":"id-80","name":"name-80","amount":0.14250252980556877},
              {"id":"id-81","name":"name-81","amount":0.6367996833282978},
              {"id":"id-82","name":"name-82","amount":0.9128964171895955},
              {"id":"id-83","name":"name-83","amount":0.09628486599612585},
              {"id":"id-84","name":"name-84","amount":0.7953020904510584},
              {"id":"id-85","name":"name-85","amount":0.231920241899784},
              {"id":"id-86","name":"name-86","amount":0.7392558278331737},
              {"id":"id-87","name":"name-87","amount":0.609970864603982},
              {"id":"id-88","name":"name-88","amount":0.48733224720522117},
              {"id":"id-89","name":"name-89","amount":0.32036972083036486},
              {"id":"id-90","name":"name-90","amount":0.3311762863025144},
              {"id":"id-91","name":"name-91","amount":0.43275371790431616},
              {"id":"id-92","name":"name-92","amount":0.6874654016957533},
              {"id":"id-93","name":"name-93","amount":0.16057871158962123},
              {"id":"id-94","name":"name-94","amount":0.04877994386383888},
              {"id":"id-95","name":"name-95","amount":0.24876563390841433},
              {"id":"id-96","name":"name-96","amount":0.4880810975593466},
              {"id":"id-97","name":"name-97","amount":0.3196628521422784},
              {"id":"id-98","name":"name-98","amount":0.41967002708790624},
              {"id":"id-99","name":"name-99","amount":0.8351177855139182}
            ]}>
          </slim_table_list.TableListViewPaged>
        </ui_static.Div>
      </ReactNative.View>

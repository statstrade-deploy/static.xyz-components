...
import ui_notify from '../js/react-native/ui-notify'

import slim_submit from '../melbourne/slim-submit'

import n from '../js/react-native'

import ui_topnotify from '../pune/ui-topnotify'
...
import ui_mainmenu from '../pune/ui-mainmenu'
  ...
  return (
    <ui_mainmenu.MainMenu
      items={[
        ...
        {
            "component":ui_mainmenu.MainMenuToggle,
            "key":"h3",
            "icon":"browser",
            "label":"CONSOLE",
            "design":design,
        ...
        {
            "component":ui_mainmenu.MainMenuButton,
            "key":"h3",
            "icon":"sound",
            "label":"NOTIFY",
            "onPress":function (){
...
function FrameNotify({design,showNotify,setShowNotify,inbox,setInbox}){
  ...
  return (
    <ui_notify.Notify position="bottom_right" visible={showNotify} margin={10}>
